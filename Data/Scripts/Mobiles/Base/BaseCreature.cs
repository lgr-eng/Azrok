...
namespace Server.Mobiles
{
    ...
    public class BaseCreature : Mobile, IHonorTarget
    {
        ...
        {
            get { return (Skills[SkillName.Necromancy].Value > 50); }
        }

        public virtual bool IsBondable
        {
            get { return (BondingEnabled && !Summoned); }
        }
        ...
        {
            get { return !m_IsDeadPet && base.CanRegenHits; }
        }
        public override bool CanRegenStam
        {
            get { return !m_IsDeadPet && base.CanRegenStam; }
        }
        public override bool CanRegenMana
        {
            get { return !m_IsDeadPet && base.CanRegenMana; }
        }
        ...
        {
            get { return SubdueBeforeTame && (Hits < (HitsMax / 10)); }
        }
        ...
        public virtual void BreathEffect_Callback(object state)
        {
            ...
            if (BreathEffectItemID > 0)
            {
                BreathPlayEffect(target);
            }

            Timer.DelayCall(
                TimeSpan.FromSeconds(BreathDamageDelay),
                new TimerStateCallback(BreathDamage_Callback),
                target
            );
        }
        ...
        public void DoFinalBreathAttack(Mobile target, int form, bool cycle)
        {
            ...
            else if (form == 2) // POTIONS THROWN -------------------------------------------------------------------------------------------------
            {
                ...
                else if (BreathEffectHue == 0xB92)
                {
                    Effects.SendLocationParticles(
                        EffectItem.Create(blast1, target.Map, EffectItem.DefaultDuration),
                        0x36B0,
                        1,
                        14,
                        63,
                    ...
                    if (!(Server.Items.HiddenTrap.SavingThrow(target, "Poison", false)))
                    {
                        ...
                        {
                            case 1:
                                target.ApplyPoison(target, Poison.Lesser);
                                break;
                            case 2:
            ...
            else if (form == 3) // DAGGERS OR STARS THROWN ----------------------------------------------------------------------------------------
            {
                if (target is PlayerMobile && Server.Items.BaseRace.IsBleeder(target))
                {
                    ...
                    blood.MoveToWorld(blast2, this.Map);
                    blood = new Blood();
                    blood.MoveToWorld(blast3, this.Map);
                    blood = new Blood();
                    blood.MoveToWorld(blast4, this.Map);
                    blood = new Blood();
                    blood.MoveToWorld(blast5, this.Map);
                }
            ...
            else if (form == 8) // LARGE SAND BREATH ----------------------------------------------------------------------------------------------
            {
                Effects.SendLocationEffect(
                    ...
                    30,
                    10,
                    Utility.RandomList(0xB4D, 0xB4E),
                    0
                );
                Effects.SendLocationEffect(
                    blast2w,
            ...
            else if (form == 10) // LARGE POISON BREATH -------------------------------------------------------------------------------------------
            {
                ...
                else
                {
                    ...
                    Effects.SendLocationParticles(
                        EffectItem.Create(blast2, target.Map, EffectItem.DefaultDuration),
                        0x36B0,
                        1,
                        14,
                        63,
                    ...
                    Effects.SendLocationParticles(
                        EffectItem.Create(blast3, target.Map, EffectItem.DefaultDuration),
                        0x36B0,
                        1,
                        14,
                        63,
                    ...
                    Effects.SendLocationParticles(
                        EffectItem.Create(blast4, target.Map, EffectItem.DefaultDuration),
                        0x36B0,
                        1,
                        14,
                        63,
                    ...
                    Effects.SendLocationParticles(
                        EffectItem.Create(blast5, target.Map, EffectItem.DefaultDuration),
                        0x36B0,
                        1,
                        14,
                        63,
                ...
                if (!(Server.Items.HiddenTrap.SavingThrow(target, "Poison", false)))
                {
                    ...
                    {
                        case 1:
                            target.ApplyPoison(target, Poison.Greater);
                            break;
                        case 2:
            ...
            else if (form == 32) // SMALL FALLING ICE ---------------------------------------------------------------------------------------------
            {
                ...
                else
                {
                    Effects.SendLocationEffect(
                        blast1,
                        target.Map,
                        Utility.RandomList(0x384E, 0x3859),
                        85,
                        10,
                        BreathEffectHue,
                        0
        ...
        */
        ...
        public virtual bool IsFriend(Mobile m)
        {
            ...
            return (
                m_iTeam == c.m_iTeam
                && ((m_bSummoned || m_bControlled) == (c.m_bSummoned || c.m_bControlled)) /* && c.Combatant != this */
            );
        }
        ...
        public virtual bool IsEnemy(Mobile m)
        {
            ...
            if (
                ...
                && Hidden
                && m is PlayerMobile
                && !Server.Mobiles.BasePirate.IsSailor(this)
            ) // SURFACE FROM WATER AND ATTACK
            {
            ...
            if (
                ...
                && this.ControlSlots != 666
                && (m is BaseVendor || GetPlayerInfo.EvilPlayer(m))
                && (
                    this is Bat
                    || this is DiseasedRat
                    || this is DarkHound
        ...
        public static bool AlwaysInvulnerable(Mobile m)
        {
            ...
            else if (m is PackTurtle)
            {
                return true;
            }
            else if (m is HenchmanFamiliar)
            {
                return true;
            }
            else if (m is AerialServant)
            {
                return true;
            }
            else if (m is PackBeast)
            {
                return true;
            }
            else if (m is FrankenPorter)
            {
                return true;
            }
            else if (m is GolemPorter)
            {
                return true;
            }
            else if (m is EtherealDealer)
            {
                return true;
            }
            else if (m is TavernPatronEast)
            {
                return true;
            }
            else if (m is TavernPatronNorth)
            {
                return true;
            }
            else if (m is TavernPatronSouth)
            {
                return true;
            }
            else if (m is TavernPatronWest)
            {
                return true;
            }
            else if (m is AdventurerEast)
            {
                return true;
            }
            else if (m is AdventurerNorth)
            {
                return true;
            }
            else if (m is AdventurerSouth)
            {
                return true;
            }
            else if (m is AdventurerWest)
            {
                return true;
            }
            else if (m is Citizens)
            {
                return true;
            }
            else if (m is EpicPet)
            {
                return true;
            }
            else if (m is EpicCharacter)
            {
                return true;
            }
            else if (m is DeathKnightDemon)
            {
                return true;
            }
            else if (m is ElementalSteed)
            {
                return true;
            }
            else if (m is DraculaBride)
            {
                return true;
            }
            else if (m is GodOfLegends)
            {
                return true;
            }
            else if (m is NecroGreeter)
            {
                return true;
            }
            else if (m is Priest)
        ...
        public virtual double GetControlChance(Mobile m, bool useBaseSkill)
        {
            ...
            int taming = (int)(
                (useBaseSkill ? m.Skills[SkillName.Taming].Base : m.Skills[SkillName.Taming].Value)
                * 10
            );
            int lore = (int)(
                (useBaseSkill ? m.Skills[SkillName.Taming].Base : m.Skills[SkillName.Taming].Value)
            ...
            if (m.Skills[SkillName.Druidism].Base > m.Skills[SkillName.Taming].Base && useBaseSkill)
                lore = (int)(
                    (
                        useBaseSkill
                            ? m.Skills[SkillName.Druidism].Base
                            : m.Skills[SkillName.Druidism].Value
                    ) * 10
                );
        ...
        public override void Damage(int amount, Mobile from)
        {
            ...
            if (
                from is BaseCreature
                && !((BaseCreature)from).Summoned
                && !((BaseCreature)from).Controlled
                && IsPet(this)
                && MyServerSettings.DamageToPets() > 1.0
            )
            {
            ...
            if (
                ...
                && !((BaseCreature)from).Controlled
                && IsPet(this)
                && MyServerSettings.CriticalToPets() >= Utility.RandomMinMax(1, 100)
            )
            {
                amount = amount * 2;
            }
        ...
        {
            if (
                (Paragon.CheckConvert(this, location, m))
                && (this.Karma < -999)
                && (this.EmoteHue != 123)
                && !(this.Region is GargoyleRegion)
                && !(this.Region.IsPartOf("the Castle of the Black Knight"))
            )
                IsParagon = true;
        ...
        public static void AdditionalHitPoints(BaseCreature bc, int DungeonDifficulty)
        {
            ...
            {
                HitPercents = (DungeonDifficulty * 10) * 0.01;
            }
        ...
        public static void BeefUp(BaseCreature bc, int up)
        {
            ...
            else if (bc.Fame >= 18000 && up > 1)
            {
                up = 1;
            }
            else if (bc.Fame >= 15000 && up > 2)
            {
                up = 2;
            }
            else if (bc.Fame >= 10000 && up > 3)
            {
                up = 3;
            }
            ...
            {
                double searching = (double)(
                    Server.Misc.IntelligentAction.GetCreatureLevel((Mobile)bc) + 10
                );
        ...
        public override void OnAfterSpawn()
        {
            ...
            if (
                !IsCitizen()
                && Server.Misc.MyServerSettings.LineOfSightOn()
                && WhisperHue != 999
                && WhisperHue != 666
                && !CanHearGhosts
                && !Controlled
                && (
                    this.Region is DungeonRegion
                    || this.Region is DeadRegion
                    || this.Region is CaveRegion
                    || this.Region is BardDungeonRegion
                    || this.Region is OutDoorBadRegion
                )
            )
            {
                CanHearGhosts = true;
            ...
            if (
                ...
                || this is Vulcrum
                || this is Arachnar
                || this is CaddelliteDragon
            )
            {
                Heat = 4;
            } // TIME LORD TRIAL CREATURES GET HP BUFF

            // BARDS TALE TWEAKS
            if (reg.IsPartOf("Mangar's Tower") && this.Fame >= 5000)
            {
                Heat = 1;
            }
            else if (reg.IsPartOf("Mangar's Chamber") && this.Fame >= 5000)
            {
                Heat = 1;
            }
            else if (reg.IsPartOf("Kylearan's Tower") && this.Fame >= 5000)
            {
                Heat = 1;
            }

            if (this.Name == "a vampire")
            {
                this.Title = null;
            }
            else if (this.Name == "a young vampire")
            {
                this.Title = null;
            }
            else if (this.Name == "a vampire lord")
            {
                this.Title = null;
            }
            else if (this.Name == "a vampire prince")
            {
                this.Title = null;
            }
            ...
            if (reg.IsPartOf("the Lyceum"))
            {
                ...
                else if (this is Sage || this is Shepherd)
                {
                    ...
                    {
                        (this.FindItemOnLayer(Layer.OneHanded)).Delete();
                    }
                    if (this.FindItemOnLayer(Layer.FirstValid) != null)
                    {
                        (this.FindItemOnLayer(Layer.FirstValid)).Delete();
                    }
            ...
            if (Region.IsPartOf(typeof(PirateRegion))) // GHOST PIRATE SHIP ////////////////////////////////////////
            {
                ...
                {
                    this.Name = "a dead pirate";
                }
                else if (this is SkeletalKnight)
                {
                ...
                {
                    this.Name = "a rotting pirate";
                }
                else if (this is Spectre)
                {
                    this.Name = "a spectral pirate";
                }
                else if (this is AncientLich)
                {
                    ...
                    MyChest.ContainerOwner =
                        "Treasure Chest of " + this.Name + " " + this.Title + "";
                    MyChest.Hue = 0x47E;
            ...
            if (
                ...
                && Server.Misc.Worlds.IsMainRegion(
                    Server.Misc.Worlds.GetRegionName(this.Map, this.Location)
                )
            ) // FOR HORSE RIDERS
            {
                if (
            ...
            if (reg.IsPartOf(typeof(BardDungeonRegion)))
            {
                ...
                else if (reg.IsPartOf("Harkyn's Castle"))
                {
                    ...
                    if (this is StoneElemental)
                    {
                        this.Name = "a stone golem";
                    }
                    if (this is FrostGiant)
                    {
                        this.Title = "the ice giant";
                    }
                ...
                else if (reg.IsPartOf("Kylearan's Tower"))
                {
                    ...
                    if (this is StoneElemental)
                    {
                        this.Name = "a stone elemental";
                    }
                    if (this is LowerDemon)
                    {
                        this.Name = "a demon";
                        this.Hue = 0x5B5;
                        this.Body = 4;
                ...
                else if (reg.IsPartOf("Mangar's Tower"))
                {
                    ...
                    if (this is Gazer)
                    {
                        this.Name = "an evil eye";
                        this.Body = 83;
                    }
                    if (this is LowerDemon)
                    {
                        this.Name = "a demon lord";
                        this.Title = "";
                        this.Body = 102;
                    }
                    if (this is Demon)
                    {
                        this.Name = "a greater demon";
                        this.Title = "";
                        this.Hue = 0;
                        this.Body = 40;
                    }
                ...
                {
                    this.Body = Utility.RandomList(7, 17, 41);
                }
            }
            ...
            if (reg.IsPartOf("the Blood Temple"))
            {
                if (this is Devil)
                {
                    ...
                    {
                        case 0:
                            this.Title = "the devil of blood";
                            break;
                        case 1:
                            this.Title = "the bleeding devil";
                            break;
                        case 2:
                            this.Title = "the blood devil";
                            break;
                        case 3:
                            this.Title = "the devil of bloody hell";
                            break;
                        case 4:
                            this.Title = "the blood moon devil";
                            break;
                    }
            ...
            if (reg.IsPartOf("the Ancient Crash Site") || reg.IsPartOf("the Ancient Sky Ship"))
            {
                if (this is Fungal)
                {
                    this.Name = "a mushroom man";
                    this.Hue = 0x48F;
                    this.AddItem(new LightSource());
                }
                else if (this is FungalMage)
                {
                    this.Name = "a psychic mushroom";
                    this.Hue = 0xABA;
                    this.AddItem(new LightSource());
                }
                else if (this is ToxicElemental)
                {
                    this.Name = "a toxic waste elemental";
                    this.Hue = 0xBA1;
                    this.AddItem(new LighterSource());
                    this.Body = 707;
                }
                else if (this is PoisonBeetle)
                {
                    this.Name = "a rad beetle";
                    this.Hue = 0xB07;
                    this.AddItem(new LighterSource());
                }
                else if (this is PoisonBeetleRiding)
                {
                    this.Name = "a rad beetle";
                    this.Hue = 0xB07;
                    this.AddItem(new LighterSource());
                }
                else if (this is ElectricalElemental)
                {
                    this.Name = "a plasma elemental";
                    this.Hue = 0xB53;
                }
                else if (this is Stirge)
                {
                    this.Name = "a mynock";
                    this.Body = 742;
                }
                ...
                {
                    this.AddItem(new LighterSource());
                    if (this.X > 954 && this.Y > 3771 && this.X < 976 && this.Y < 3793)
                    {
                        this.Name = "a coolant elemental";
                        this.Hue = 0xB73;
                    }
                    else
                    {
                        this.Name = "a contaminated elemental";
                        this.Hue = 0xBAD;
                    }
                }
            }
            ...
            if (
                ...
                && Server.Misc.Worlds.GetRegionName(this.Map, this.Location) == "the Savaged Empire"
            )
            {
            ...
            if (reg.IsPartOf("the Forgotten Halls"))
            {
                if (
                    this is Daemon
                    && Server.Misc.SummonQuests.IsInLocation(
                        this.Home.X,
                        this.Home.Y,
                        this.Map,
                        409,
                ...
                )
                {
                    ...
                    {
                        case 0:
                            this.Title = "the daemon of filth";
                            break;
                        case 1:
                            this.Title = "the daemon of crud";
                            break;
                        case 2:
                            this.Title = "the daemon of grime";
                            break;
                        case 3:
                            this.Title = "the daemon of sludge";
                            break;
                        case 4:
                            this.Title = "the daemon of the putrid";
                            break;
                    }
                }
                if (this is ToxicElemental)
                {
                    this.Name = "a sewage elemental";
                    this.Hue = Hue = 0xB97;
                }
                if (this is ForestGiant)
                {
                    this.Hue = Hue = 0xB97;
                    this.Title = "the sludge giant";
                }
                if (this is AncientLich)
                {
                    ...
                    if (Utility.Random(3) == 1)
                    {
                        ...
                        {
                            case 0:
                                BoneArms radarm = new BoneArms();
                                radarm.Name = "shadow lich arms";
                                radarm.Hue = 0x497;
                                ...
                                this.PackItem(radarm);
                                break;
                            case 1:
                                BoneChest radchest = new BoneChest();
                                radchest.Name = "shadow lich chest";
                                radchest.Hue = 0x497;
                                BaseRunicTool.ApplyAttributesTo(
                                    (BaseArmor)radchest,
                                    false,
                                ...
                                this.PackItem(radchest);
                                break;
                            case 2:
                                BoneGloves radglove = new BoneGloves();
                                radglove.Name = "shadow lich gloves";
                                radglove.Hue = 0x497;
                                BaseRunicTool.ApplyAttributesTo(
                                    (BaseArmor)radglove,
                                    false,
                                ...
                                this.PackItem(radglove);
                                break;
                            case 3:
                                BoneLegs radleg = new BoneLegs();
                                radleg.Name = "shadow lich leggings";
                                radleg.Hue = 0x497;
                                BaseRunicTool.ApplyAttributesTo(
                                    (BaseArmor)radleg,
                                    false,
                                ...
                                this.PackItem(radleg);
                                break;
                            case 4:
                                BoneHelm radhelm = new BoneHelm();
                                radhelm.Name = "shadow lich helm";
                                radhelm.Hue = 0x497;
                                BaseRunicTool.ApplyAttributesTo(
                                    (BaseArmor)radhelm,
                                    false,
                ...
                if (this is SkeletalKnight)
                {
                    ...
                    if (Utility.Random(4) == 1)
                    {
                        switch (Utility.Random(5))
                        {
                            case 0:
                                BoneArms radarm = new BoneArms();
                                radarm.Name = "rotting bone arms";
                                radarm.Hue = 0xB97;
                                radarm.PoisonBonus = 10;
                                this.PackItem(radarm);
                                break;
                            case 1:
                                BoneChest radchest = new BoneChest();
                                radchest.Name = "rotting bone chest";
                                radchest.Hue = 0xB97;
                                radchest.PoisonBonus = 10;
                                this.PackItem(radchest);
                                break;
                            case 2:
                                BoneGloves radglove = new BoneGloves();
                                radglove.Name = "rotting bone gloves";
                                radglove.Hue = 0xB97;
                                radglove.PoisonBonus = 10;
                                this.PackItem(radglove);
                                break;
                            case 3:
                                BoneLegs radleg = new BoneLegs();
                                radleg.Name = "rotting bone leggings";
                                radleg.Hue = 0xB97;
                                radleg.PoisonBonus = 10;
                                this.PackItem(radleg);
                                break;
                            case 4:
                                BoneHelm radhelm = new BoneHelm();
                                radhelm.Name = "rotting bone helm";
                                radhelm.Hue = 0xB97;
                                radhelm.PoisonBonus = 10;
                                this.PackItem(radhelm);
                                break;
                        }
                    }

                    if (this.Body == 56 || this.Body == 168)
                    {
                        BattleAxe radaxe = new BattleAxe();
                        radaxe.Name = "rusty battle axe";
                        radaxe.Hue = 0xB97;
                        radaxe.AosElementDamages.Poison = 50;
                        this.PackItem(radaxe);
                    }
                    if (this.Body == 57)
                    {
                        Scimitar radsim = new Scimitar();
                        radsim.Name = "rusty scimitar";
                        radsim.Hue = 0xB97;
                        radsim.AosElementDamages.Poison = 50;
                        this.PackItem(radsim);
                    }
                    if (this.Body == 170 || this.Body == 327)
                    {
                        Longsword radswd = new Longsword();
                        radswd.Name = "rusty longsword";
                        radswd.Hue = 0xB97;
                        radswd.AosElementDamages.Poison = 50;
                        this.PackItem(radswd);
                    }
                    if (this.Body == 57 || this.Body == 168 || this.Body == 170)
                    {
                        WoodenShield radshield = new WoodenShield();
                        radshield.Name = "rotting shield";
                        radshield.Hue = 0xB97;
                        radshield.PoisonBonus = 5;
                        this.PackItem(radshield);
                    }
                }
            }
                ...
                if (this is AncientLich)
                {
                    ...
                    if (Utility.Random(3) == 1)
                    {
                        switch (Utility.Random(5))
                        {
                            ...
                            case 1:
                                BoneChest radchest = new BoneChest();
                                radchest.Name = "Kazibal bone chest";
                                radchest.Hue = 0x83B;
                                BaseRunicTool.ApplyAttributesTo(
                                    (BaseArmor)radchest,
                                    false,
                            ...
                            case 2:
                                BoneGloves radglove = new BoneGloves();
                                radglove.Name = "Kazibal bone gloves";
                                radglove.Hue = 0x83B;
                                BaseRunicTool.ApplyAttributesTo(
                                    (BaseArmor)radglove,
                                    false,
                            ...
                            case 3:
                                BoneLegs radleg = new BoneLegs();
                                radleg.Name = "Kazibal bone leggings";
                                radleg.Hue = 0x83B;
                                BaseRunicTool.ApplyAttributesTo(
                                    (BaseArmor)radleg,
                                    false,
                            ...
                            case 4:
                                BoneHelm radhelm = new BoneHelm();
                                radhelm.Name = "Kazibal bone helm";
                                radhelm.Hue = 0x83B;
                                BaseRunicTool.ApplyAttributesTo(
                                    (BaseArmor)radhelm,
                                    false,
                ...
                if (this is BoneKnight)
                {
                    ...
                    if (Utility.Random(4) == 1)
                    {
                        switch (Utility.Random(5))
                        {
                            case 0:
                                BoneArms radarm = new BoneArms();
                                radarm.Name = "irradiated bone arms";
                                radarm.Hue = 0x48F;
                                radarm.PoisonBonus = 10;
                                this.PackItem(radarm);
                                break;
                            case 1:
                                BoneChest radchest = new BoneChest();
                                radchest.Name = "irradiated bone chest";
                                radchest.Hue = 0x48F;
                                radchest.PoisonBonus = 10;
                                this.PackItem(radchest);
                                break;
                            case 2:
                                BoneGloves radglove = new BoneGloves();
                                radglove.Name = "irradiated bone gloves";
                                radglove.Hue = 0x48F;
                                radglove.PoisonBonus = 10;
                                this.PackItem(radglove);
                                break;
                            case 3:
                                BoneLegs radleg = new BoneLegs();
                                radleg.Name = "irradiated bone leggings";
                                radleg.Hue = 0x48F;
                                radleg.PoisonBonus = 10;
                                this.PackItem(radleg);
                                break;
                            case 4:
                                BoneHelm radhelm = new BoneHelm();
                                radhelm.Name = "irradiated bone helm";
                                radhelm.Hue = 0x48F;
                                radhelm.PoisonBonus = 10;
                                this.PackItem(radhelm);
                                break;
                    ...
                    {
                        BattleAxe radaxe = new BattleAxe();
                        radaxe.Name = "irradiated battle axe";
                        radaxe.Hue = 0x48F;
                        radaxe.AosElementDamages.Poison = 50;
                        this.PackItem(radaxe);
                    }
                    ...
                    {
                        Scimitar radsim = new Scimitar();
                        radsim.Name = "irradiated scimitar";
                        radsim.Hue = 0x48F;
                        radsim.AosElementDamages.Poison = 50;
                        this.PackItem(radsim);
                    }
                    ...
                    {
                        Longsword radswd = new Longsword();
                        radswd.Name = "irradiated longsword";
                        radswd.Hue = 0x48F;
                        radswd.AosElementDamages.Poison = 50;
                        this.PackItem(radswd);
                    }
                    ...
                    {
                        WoodenShield radshield = new WoodenShield();
                        radshield.Name = "irradiated shield";
                        radshield.Hue = 0x48F;
                        radshield.PoisonBonus = 5;
                        this.PackItem(radshield);
                    }
            ...
            if (reg.IsPartOf("the Tower of Brass"))
            {
                if (this is BloodDemon)
                {
                    ...
                    {
                        case 0:
                            this.Title = "the ice daemon";
                            break;
                        case 1:
                            this.Title = "the daemon of ice";
                            break;
                        case 2:
                            this.Title = "of the icy veil";
                            break;
                        case 3:
                            this.Title = "of the frozen void";
                            break;
                        case 4:
                            this.Title = "of the frozen wastes";
                            break;
                        case 5:
                            this.Title = "of the icy depths";
                            break;
                    }
                }
                else if (this is CrystalElemental)
                ...
                )
                {
                    for (int i = 0; i < this.Items.Count; ++i)
                    {
                        ...
                        if (item is BaseWeapon)
                        {
                            ...
                            if (
                                Server.Misc.MaterialInfo.IsMetalItem(item)
                                && Utility.RandomMinMax(1, 20) == 1
                            )
                            {
                                iweapon.Resource = CraftResource.Brass;
                                iweapon.Hue = MaterialInfo.GetMaterialColor("brass", "", 0);
                            }
                            else
                            {
                                item.Hue = Utility.RandomYellowHue();
                        ...
                        else if (item is BaseArmor)
                        {
                            ...
                            {
                                iarmor.Resource = CraftResource.Brass;
                                iarmor.Hue = MaterialInfo.GetMaterialColor("brass", "", 0);
                            }
                            else
                            {
                                item.Hue = Utility.RandomYellowHue();
                    ...
                    foreach (Item i in this.Backpack.Items)
                    {
                        if (i is BaseWeapon && Utility.RandomMinMax(1, 20) == 1)
                        {
                            ...
                            if (Server.Misc.MaterialInfo.IsMetalItem(i))
                            {
                                iweapon.Resource = CraftResource.Brass;
                            }
                        }
            ...
            if (reg.IsPartOf("the Castle of Dracula"))
            {
                if (this is OrcCaptain)
                {
                    ...
                    if (Utility.RandomMinMax(1, 10) > 3)
                    {
                        ...
                        {
                            case 0:
                                this.PackItem(new BreadLoaf(Utility.RandomMinMax(1, 3)));
                                break;
                            case 1:
                                this.PackItem(new CheeseWheel(Utility.RandomMinMax(1, 3)));
                                break;
                            case 2:
                                this.PackItem(new Ribs(Utility.RandomMinMax(1, 3)));
                                break;
                            case 3:
                                this.PackItem(new Apple(Utility.RandomMinMax(1, 3)));
                                break;
                            case 4:
                                this.PackItem(new CookedBird(Utility.RandomMinMax(1, 3)));
                                break;
                            case 5:
                                this.PackItem(new LambLeg(Utility.RandomMinMax(1, 3)));
                                break;
                        }
                    }
                    if (Utility.RandomMinMax(1, 10) > 3)
                    {
                        ...
                        {
                            case 0:
                                this.PackItem(new BeverageBottle(BeverageType.Ale));
                                break;
                            case 1:
                                this.PackItem(new BeverageBottle(BeverageType.Wine));
                                break;
                            case 2:
                                this.PackItem(new BeverageBottle(BeverageType.Liquor));
                                break;
                            case 3:
                                this.PackItem(new Jug(BeverageType.Cider));
                                break;
                            case 4:
                                this.PackItem(new Waterskin());
                                break;
                        }
                    }
                    if (Utility.RandomMinMax(1, 10) > 3)
                    {
                        ...
                        {
                            case 0:
                                this.PackItem(new Torch());
                                break;
                            case 1:
                                this.PackItem(new Candle());
                                break;
                            case 2:
                                this.PackItem(new Lantern());
                                break;
                        }
                    }
                }
            ...
            if (reg.IsPartOf("Stonegate Castle"))
            {
                ...
                )
                {
                    if (Utility.RandomMinMax(1, 4) == 1)
                    {
                        ...
                        {
                            case 0:
                                bonearmor = new BoneChest();
                                bonearmor.Name = "daemon ash bone tunic";
                                reflect = 12;
                                break;
                            case 1:
                                bonearmor = new BoneArms();
                                bonearmor.Name = "daemon ash bone bracers";
                                reflect = 8;
                                break;
                            case 2:
                                bonearmor = new BoneLegs();
                                bonearmor.Name = "daemon ash bone leggings";
                                reflect = 10;
                                break;
                            case 3:
                                bonearmor = new BoneGloves();
                                bonearmor.Name = "daemon ash bone gauntlets";
                                reflect = 6;
                                break;
                            case 4:
                                bonearmor = new BoneHelm();
                                bonearmor.ItemID = 0x1F0C;
                                bonearmor.Name = "daemon ash bone helm";
                                reflect = 6;
                                break;
                        }
                ...
                else if (this is BoneKnight)
                {
                    ...
                    if (
                        this.Body == 50
                        || this.Body == 57
                        || (this.Body == 56 && Utility.Random(4) == 1)
                    )
                    {
                        switch (Utility.Random(5))
                        {
                            case 0:
                                BoneArms asharm = new BoneArms();
                                asharm.Name = "burnt bone arms";
                                asharm.Hue = 0xA78;
                                asharm.FireBonus = 10;
                                this.PackItem(asharm);
                                break;
                            case 1:
                                BoneChest ashchest = new BoneChest();
                                ashchest.Name = "burnt bone chest";
                                ashchest.Hue = 0xA78;
                                ashchest.FireBonus = 10;
                                this.PackItem(ashchest);
                                break;
                            case 2:
                                BoneGloves ashglove = new BoneGloves();
                                ashglove.Name = "burnt bone gloves";
                                ashglove.Hue = 0xA78;
                                ashglove.FireBonus = 10;
                                this.PackItem(ashglove);
                                break;
                            case 3:
                                BoneLegs ashleg = new BoneLegs();
                                ashleg.Name = "burnt bone leggings";
                                ashleg.Hue = 0xA78;
                                ashleg.FireBonus = 10;
                                this.PackItem(ashleg);
                                break;
                            case 4:
                                BoneHelm ashhelm = new BoneHelm();
                                ashhelm.Name = "burnt bone helm";
                                ashhelm.Hue = 0xA78;
                                ashhelm.FireBonus = 10;
                                this.PackItem(ashhelm);
                                break;
                        }
                    }
                    ...
                    {
                        BattleAxe radaxe = new BattleAxe();
                        radaxe.Name = "burnt battle axe";
                        radaxe.Hue = 0xA78;
                        radaxe.AosElementDamages.Fire = 50;
                        this.PackItem(radaxe);
                    }
                    if (this.Body == 57)
                    {
                        Scimitar radsim = new Scimitar();
                        radsim.Name = "burnt scimitar";
                        radsim.Hue = 0xA78;
                        radsim.AosElementDamages.Fire = 50;
                        this.PackItem(radsim);
                    }
                    if (this.Body == 170 || this.Body == 327)
                    {
                        Longsword radswd = new Longsword();
                        radswd.Name = "burnt longsword";
                        radswd.Hue = 0xA78;
                        radswd.AosElementDamages.Fire = 50;
                        this.PackItem(radswd);
                    }
                    if (this.Body == 57 || this.Body == 168 || this.Body == 170)
                    {
                        WoodenShield radshield = new WoodenShield();
                        radshield.Name = "burnt shield";
                        radshield.Hue = 0xA78;
                        radshield.FireBonus = 5;
                        this.PackItem(radshield);
                    }
                }
            }
            if (reg.IsPartOf("the Ancient Elven Mine") || reg.IsPartOf("the Undersea Pass"))
            {
                ...
                if (this is Urk)
                {
                    ...
                    if (DressUpAs == 1)
                    {
                        ...
                        {
                            drowarms.LootType = LootType.Blessed;
                        }
                        drowarms.Hue = 0x966;
                        AddItem(drowarms);
                        ...
                        if (Utility.RandomMinMax(1, 10) > 1)
                        {
                            drowchest.LootType = LootType.Blessed;
                        }
                        drowchest.Hue = 0x966;
                        AddItem(drowchest);
                        ...
                        if (Utility.RandomMinMax(1, 10) > 1)
                        {
                            drowgloves.LootType = LootType.Blessed;
                        }
                        ...
                        if (Utility.RandomMinMax(1, 10) > 1)
                        {
                            drowgorget.LootType = LootType.Blessed;
                        }
                        ...
                        if (Utility.RandomMinMax(1, 10) > 1)
                        {
                            drowlegs.LootType = LootType.Blessed;
                        }
                        drowlegs.Hue = 0x966;
                        AddItem(drowlegs);
                    }
                    else if (DressUpAs == 2)
                    {
                        ...
                        if (Utility.RandomMinMax(1, 10) > 1)
                        {
                            bonelegs.LootType = LootType.Blessed;
                        }
                        bonelegs.Hue = 0x966;
                        AddItem(bonelegs);
                    ...
                    else // MINER
                    {
                        ...
                        if (Utility.RandomMinMax(1, 10) > 1)
                        {
                            minegloves.LootType = LootType.Blessed;
                        }
                    ...
                    if (DressUpAs < 3)
                    {
                        ...
                        switch (Utility.Random(28))
                        {
                            ...
                            case 2:
                                ...
                                break;
                            case 3:
                                weapon = new DoubleAxe();
                                weapon.Name = "double axe";
                                break;
                            case 4:
                            ...
                            case 13:
                                ...
                                break;
                            case 14:
                                weapon = new BoneHarvester();
                                weapon.Name = "sickle";
                                break;
                            case 15:
                                weapon = new CrescentBlade();
                                weapon.Name = "crescent blade";
                                break;
                            case 16:
                                weapon = new DoubleBladedStaff();
                                weapon.Name = "double bladed staff";
                                break;
                            case 17:
                                weapon = new Pike();
                                weapon.Name = "pike";
                            ...
                            case 19:
                                ...
                                weapon.Name = "trident";
                                weapon.Hue = Server.Misc.MaterialInfo.PlainIronColor(weapon.ItemID);
                                break;
                            case 20:
                                weapon = new ShortSpear();
                                weapon.Name = "rapier";
                                break;
                            case 21:
                                weapon = new Spear();
                            ...
                            case 22:
                                ...
                                break;
                            case 23:
                                weapon = new HammerPick();
                                weapon.Name = "hammer pick";
                                break;
                            case 24:
                                weapon = new Mace();
                                weapon.Name = "mace";
                        ...
                        {
                            case 0:
                                this.Title = "the orc warrior";
                                break;
                            case 1:
                                this.Title = "the orc savage";
                                break;
                            case 2:
                                this.Title = "the orc barbarian";
                                break;
                            case 3:
                                this.Title = "the orc fighter";
                                break;
                            case 4:
                                this.Title = "the orc gladiator";
                                break;
                            case 5:
                                this.Title = "the orc berserker";
                                break;
                        }
                    }
                }
            ...
            if (reg.IsPartOf("the Caverns of Poseidon"))
            {
                if (this is DeepSeaSerpent)
                {
                    ...
                    {
                        case 0:
                            this.Title = "from the frozen deep";
                            break;
                        case 1:
                            this.Title = "of the darkest sea";
                            break;
                        case 2:
                            this.Title = "from the deepest depths";
                            break;
                        case 3:
                            this.Title = "of the cold sea";
                            break;
                        case 4:
                            this.Title = "of the icy waves";
                            break;
                        case 5:
                            this.Title = "of the icy sea";
                            break;
                    }
                    this.AddItem(new LightSource());
                }
                ...
                else if (this is Devil)
                {
                    ...
                    {
                        case 0:
                            this.Title = "the nox devil";
                            break;
                        case 1:
                            this.Title = "the shard devil";
                            break;
                        case 2:
                            this.Title = "of the poison veil";
                            break;
                        case 3:
                            this.Title = "of the venomous void";
                            break;
                        case 4:
                            this.Title = "of the foul wastes";
                            break;
                        case 5:
                            this.Title = "of the crystal depths";
                            break;
                    }
                }
                else if (this is BoneKnight)
            ...
            {
                if (this is LivingShadowIronStatue)
                {
                    this.Body = 485;
                }
                if (this is LivingGoldStatue)
                {
                    this.Body = 485;
                }
                if (this is LivingBronzeStatue)
                {
                    this.Body = 485;
                }
            }
            ...
            if (this.Backpack != null)
            {
                ...
                {
                    if (
                        (Region.Find(this.Location, this.Map)).IsPartOf("the Ancient Crash Site")
                    ...
                    )
                    {
                        ...
                        (Region.Find(this.Location, this.Map)).IsPartOf("the Mines of Morinia")
                    ...
                    )
                    {
                        ...
                        Worlds.GetMyWorld(this.Map, this.Location, this.X, this.Y)
                        == "the Underworld"
                    )
                    {
            ...
            if (this.Body != 400 && this.Body != 401)
            {
                this.TithingPoints = this.Body;
            } // STORE THE BODY VALUE IN AN UNUSED VARIABLE FOR NECRO ANIMATE
        ...
        public override ApplyPoisonResult ApplyPoison(Mobile from, Poison poison)
        {
            ...
            if (
                from != null
                && result == ApplyPoisonResult.Poisoned
                && PoisonTimer is PoisonImpl.PoisonTimer
            )
        ...
        {
            get { return !this.Body.IsAnimal && !this.Body.IsSea; }
        }

        public virtual bool CanMoveOverObstacles
        {
            get { return Core.AOS || this.Body.IsMonster; }
        }
        ...
        {
            get { return m_ReceivedHonorContext; }
        ...
        public override void OnDamage(int amount, Mobile from, bool willKill)
        {
            ...
            if (willKill && from is PlayerMobile)
                Timer.DelayCall(
                    ...
                    new TimerCallback(((PlayerMobile)from).RecoverAmmo)
                );
        ...
        public virtual void OnCarve(Mobile from, Corpse corpse, Item with)
        {
            ...
            if (
                from.Backpack.FindItemByType(typeof(FrankenJournal)) != null
                && !(corpse.VisitedByTaxidermist)
                && from.Skills[SkillName.Forensics].Value >= Utility.RandomMinMax(30, 250)
                && giant.Slays(frank)
            )
            {
                Item piece = new FrankenLegLeft();
                piece.Delete();

                switch (Utility.Random(7))
                {
                    case 0:
                        piece = new FrankenLegLeft();
                        from.SendMessage("You sever off the giant's left leg.");
                        break;
                    case 1:
                        piece = new FrankenLegRight();
                        from.SendMessage("You sever off the giant's right leg.");
                        break;
                    case 2:
                        piece = new FrankenArmLeft();
                        from.SendMessage("You sever off the giant's left arm.");
                        break;
                    case 3:
                        piece = new FrankenArmRight();
                        from.SendMessage("You sever off the giant's right arm.");
                        break;
                    case 4:
                        piece = new FrankenHead();
                        from.SendMessage("You sever off the giant's head.");
                        break;
                    case 5:
                        piece = new FrankenTorso();
                        from.SendMessage("You sever apart the giant's torso.");
                        break;
                    case 6:
                        piece = new FrankenBrain();
                        from.SendMessage("You remove the giant's fresh brain.");
                        break;
                }
                ...
                if (piece is FrankenBrain)
                {
                    ...
                    if (frank.Title != "")
                    {
                        brainName = brainName + " " + frank.Title;
                    }
                    ...
                    if (brain.BrainLevel > 100)
                    {
                        brain.BrainLevel = 100;
                    }
                }
            ...
            if (
                (feathers == 0 && wool == 0 && meat == 0 && hides == 0 && scales == 0 && furs == 0)
                || Summoned
                || IsBonded
                || corpse.Animated
            )
            ...
            else
            {
                ...
                if (
                    Worlds.GetMyWorld(from.Map, from.Location, from.X, from.Y)
                    == "the Isles of Dread"
                )
                {
                    if (feathers > 0)
                    {
                        feathers = feathers + (int)(feathers / 2) + Utility.RandomMinMax(1, 5);
                    }
                    if (wool > 0)
                    {
                        wool = wool + (int)(wool / 2) + Utility.RandomMinMax(1, 5);
                    }
                    if (hides > 0)
                    {
                        hides = hides + (int)(hides / 2) + Utility.RandomMinMax(1, 5);
                    }
                    if (meat > 0)
                    {
                        meat = meat + (int)(meat / 2) + Utility.RandomMinMax(1, 5);
                    }
                    if (scales > 0)
                    {
                        scales = scales + (int)(scales / 2) + Utility.RandomMinMax(1, 5);
                    }
                    if (furs > 0)
                    {
                        furs = furs + (int)(furs / 2) + Utility.RandomMinMax(1, 5);
                    }
                }

                if (
                    (from.CheckSkill(SkillName.Forensics, 0, 100))
                    && (from.Skills[SkillName.Forensics].Base >= 5.0)
                )
                {
                    if (feathers > 0)
                    {
                        feathers =
                            feathers
                            + (int)(from.Skills[SkillName.Forensics].Value / 25)
                            + (int)(from.Skills[SkillName.Anatomy].Value / 25);
                    }
                    if (wool > 0)
                    {
                        wool =
                ...
                if (hides != 0)
                {
                    ...
                    if (Server.Misc.MaterialInfo.IsKnife(holding))
                    {
                        Item leather = null;
                        ...
                        switch (HideType)
                        {
                            ...
                            case HideType.Barbed:
                                ...
                                break;
                            case HideType.Necrotic:
                                leather = new NecroticLeather(hides);
                                break;
                            case HideType.Volcanic:
                                leather = new VolcanicLeather(hides);
                                break;
                            case HideType.Frozen:
                                leather = new FrozenLeather(hides);
                                break;
                            case HideType.Goliath:
                                leather = new GoliathLeather(hides);
                                break;
                            case HideType.Draconic:
                                leather = new DraconicLeather(hides);
                                break;
                            case HideType.Hellish:
                                leather = new HellishLeather(hides);
                                break;
                            case HideType.Dinosaur:
                                leather = new DinosaurLeather(hides);
                                break;
                            case HideType.Alien:
                                leather = new AlienLeather(hides);
                                break;
                        }
            ...
            if (
                (corpse.m_Owner is DemonOfTheSea)
            ...
            )
            {
                ...
                {
                    DemonSkin goods = new DemonSkin();
                    goods.Amount = Utility.RandomMinMax(1, 3);
                    corpse.DropItem(goods);
                }
            }
            if (
                (corpse.m_Owner is Unicorn)
                || (corpse.m_Owner is Dreadhorn)
                || (corpse.m_Owner is DarkUnicorn)
                || (corpse.m_Owner is DarkUnicornRiding)
            )
            {
                if (70 < Utility.Random(100))
                {
                    UnicornSkin goods = new UnicornSkin();
                    goods.Amount = Utility.RandomMinMax(1, 3);
                    corpse.DropItem(goods);
                }
            }
            if (
                corpse.m_Owner is Nightmare
                || corpse.m_Owner is AncientNightmare
                || corpse.m_Owner is AncientNightmareRiding
            )
            {
                if (70 < Utility.Random(100))
                {
                    NightmareSkin goods = new NightmareSkin();
                    goods.Amount = Utility.RandomMinMax(1, 3);
                    corpse.DropItem(goods);
                }
            }
            if (
                (corpse.m_Owner is Troll)
                || (corpse.m_Owner is SeaTroll)
                || (corpse.m_Owner is SwampTroll)
                || (corpse.m_Owner is FrostTroll)
            )
            {
                if (95 < Utility.Random(100))
                {
                    TrollSkin goods = new TrollSkin();
                    goods.Amount = Utility.RandomMinMax(1, 2);
                    corpse.DropItem(goods);
                }
            }
            if (
                (corpse.m_Owner is GoldenSerpent)
                || (corpse.m_Owner is BloodSnake)
                || (corpse.m_Owner is SilverSerpent)
                || (corpse.m_Owner is JungleViper)
                || (corpse.m_Owner is IceSerpent)
                || (corpse.m_Owner is GiantSerpent)
                || (corpse.m_Owner is GiantSnake)
                || (corpse.m_Owner is SeaSnake)
                || (corpse.m_Owner is LavaSerpent)
                || (corpse.m_Owner is LargeSnake)
                || (corpse.m_Owner is GiantAdder)
            )
            {
                if (95 < Utility.Random(100))
                {
                    SerpentSkin goods = new SerpentSkin();
                    goods.Amount = Utility.RandomMinMax(1, 2);
                    corpse.DropItem(goods);
                }
            }
            if (
                (corpse.m_Owner is AncientWyrm)
            ...
            )
            {
                if (95 < Utility.Random(100))
                {
                    DragonSkin goods = new DragonSkin();
                    goods.Amount = Utility.RandomMinMax(1, 3);
                    corpse.DropItem(goods);
                }
            }
        ...
        public override void Deserialize(GenericReader reader)
        {
            ...
            if (FightMode == FightMode.CharmMonster)
            {
                FightMode = FightMode.Closest;
            }
            else if (FightMode == FightMode.CharmAnimal)
            {
                FightMode = FightMode.Aggressor;
            }
        ...
        private static Type[] m_Meat = new Type[]
        {
            ...
            typeof(Ribs),
            typeof(LambLeg),
            typeof(FoodDriedBeef),
            typeof(ChickenLeg),
            typeof(FoodBeefJerky),
            /* Uncooked */
            typeof(RawBird),
            typeof(RawRibs),
            typeof(RawLambLeg),
        ...
        private static Type[] m_Fire = new Type[] { typeof(Brimstone), typeof(SulfurousAsh) };
        ...
        private static Type[] m_Sea = new Type[]
        {
            ...
            typeof(SpecialSeaweed)
        };

        private static Type[] m_Moon = new Type[] { typeof(MoonCrystal) };
        ...
        public static bool IsPet(Mobile m)
        {
            ...
            if (m is BaseCreature)
            {
                if (
                    ...
                    || m is Robot
                    || m is GolemFighter
                    || m is HenchmanMonster
                    || m is HenchmanWizard
                    || m is HenchmanArcher
                    || m is HenchmanFighter
                )
                    return false;
                ...
                if (CheckFoodPreference(f))
                {
                    ...
                    if (amount > 0)
                    {
                        ...
                        if (IsBondable && !IsBonded)
                        {
                            ...
                            {
                                if (
                                    m_dMinTameSkill <= 29.1
                                    || master.Skills[SkillName.Taming].Base >= m_dMinTameSkill
                                    || OverrideBondingReqs()
                                    || (
                                        Core.ML
                                        && master.Skills[SkillName.Taming].Value >= m_dMinTameSkill
                                    )
                                )
                                {
        ...
        public bool Tamable
        {
            get { return m_bTamable && !m_Paragon; }
        ...
        public virtual FurType FurType
        {
            get { return FurType.Regular; }
        }
        public virtual int Furs
        {
            get { return 0; }
        }
        ...
        public virtual double AutoDispelChance
        {
            ...
            {
                if (
                    this.Skills[SkillName.Magery].Value < 53
                    && this.Skills[SkillName.Necromancy].Value < 80
                )
                    return 0.0;
        ...
        {
            if (
                defender is BaseCreature
                && (
                    defender.Skills[SkillName.Magery].Value >= 53
                    || defender.Skills[SkillName.Necromancy].Value >= 80
                )
            )
            {
                ...
                if (
                    bc.IsDispellable
                    && (Utility.RandomMinMax(0, 50) + attacker.AutoDispelChance)
                        > bc.DispelDifficulty
                )
                    return true;
            }
        ...
        public virtual void OnGotMeleeAttack(Mobile attacker)
        {
            if (
                ...
                && attacker.RaceID > 0
                && attacker.RaceMakeSounds
                && attacker.RaceAttackSound > 0
                && Utility.RandomBool()
            )
            ...
            int stealing =
                Utility.RandomMinMax(1, (int)(attacker.Skills[SkillName.Stealing].Value)) + 10;
            ...
            if (
                ...
                && stealing >= 20.0
                && level < stealing
                && snooping > Utility.RandomMinMax(20, 126)
            )
            {
        ...
        public virtual void OnGaveMeleeAttack(Mobile defender)
        {
            if (
                ...
                && defender.RaceID > 0
                && defender.RaceMakeSounds
                && defender.RaceHurtSound > 0
                && Utility.RandomBool()
            )
            ...
            if (AI == AIType.AI_Archer)
            {
                ...
                if (FindItemOnLayer(Layer.OneHanded) is BaseMeleeWeapon)
                {
                    sound = ((BaseMeleeWeapon)(FindItemOnLayer(Layer.OneHanded))).DefHitSound;
                }
                else if (FindItemOnLayer(Layer.TwoHanded) is BaseMeleeWeapon)
                {
                    sound = ((BaseMeleeWeapon)(FindItemOnLayer(Layer.TwoHanded))).DefHitSound;
                }
            ...
            else if (AI == AIType.AI_Mage)
            {
                ...
                if (FindItemOnLayer(Layer.OneHanded) is BaseWizardStaff)
                {
                    sound = ((BaseMeleeWeapon)(FindItemOnLayer(Layer.OneHanded))).DefHitSound;
                }
                else if (FindItemOnLayer(Layer.TwoHanded) is BaseWizardStaff)
                {
                    sound = ((BaseMeleeWeapon)(FindItemOnLayer(Layer.TwoHanded))).DefHitSound;
                }
        ...
        private class TameEntry : ContextMenuEntry
        {
                ...
                : base(6130, 6)
            {
                ...
                Enabled =
                    Enabled && (from.Female ? creature.AllowFemaleTamer : creature.AllowMaleTamer);
            }
        ...
        public virtual bool CheckTeach(SkillName skill, Mobile from)
        {
            ...
            if (
                ...
                && from.Skills[SkillName.Hiding].Base < ((Core.SE) ? 50.0 : 80.0)
            )
                return false;
        ...
        public virtual TeachResult CheckTeachSkills(
            SkillName skill,
            Mobile m,
            int maxPointsToLearn,
            ref int pointsToLearn,
            bool doTeach
        )
        {
            ...
            for (
                int i = 0;
                (freePoints + freeablePoints) < pointsToLearn && i < m.Skills.Length;
                ++i
            )
            {
                Skill sk = m.Skills[i];
        ...
        {
            int pointsToLearn = 0;
            TeachResult res = CheckTeachSkills(
                skill,
                m,
                maxPointsToLearn,
                ref pointsToLearn,
        ...
        public override void AggressiveAction(Mobile aggressor, bool criminal)
        {
            ...
            if (undead_creatures.Slays(this) && aggressor is PlayerMobile)
            {
                ...
                if (item is DeathlyMask)
                {
                    ...
                    aggressor.LocalOverheadMessage(
                        ...
                        0x3B2,
                        false,
                        "The mask of death has vanished."
                    );
            ...
            if (
                aggressor.ChangingCombatant
                && (m_bControlled || m_bSummoned)
                && (
                    ct == OrderType.Come
                    || (!Core.ML && ct == OrderType.Stay)
                    || ct == OrderType.Stop
                    || ct == OrderType.None
                    || ct == OrderType.Follow
                )
        ...
        public override bool OnMoveOver(Mobile m)
        {
            if (m is BaseCreature && !((BaseCreature)m).Controlled)
                return (!Alive || !m.Alive || IsDeadBondedPet || m.IsDeadBondedPet)
                    || (Hidden && m.AccessLevel > AccessLevel.Player);
            ...
            if (CanTeach && from.Alive && from.Kills < 1 && !from.Criminal)
            {
                ...
                for (int i = 0; i < ourSkills.Length && i < theirSkills.Length; ++i)
                {
                    ...
                    if (
                        ...
                        && theirSkill != null
                        && skill.Base >= 60.0
                        && CheckTeach(skill.SkillName, from)
                    )
                    {
                        ...
                        list.Add(
                            new TeachEntry((SkillName)i, this, from, (toTeach > theirSkill.Base))
                        );
                    }
                }
            }
        ...
        public override bool HandlesOnSpeech(Mobile from)
        {
            ...
            if (
                speechType != null
                && (speechType.Flags & IHSFlags.OnSpeech) != 0
                && from.InRange(this, 3)
            )
                return true;

            return (
                m_AI != null && m_AI.HandlesOnSpeech(from) && from.InRange(this, m_iRangePerception)
            );
        }
        ...
        public override void DoHarmful(Mobile target, bool indirect)
        {
            ...
            if (
                target == this
                || target == m_ControlMaster
                || target == m_SummonMaster
                || (!Controlled && !Summoned)
            )
                return;
        ...
        protected override void OnLocationChange(Point3D oldLocation)
        {
            ...
            if (
                ...
                && m_AI != null
                && map != null
                && map.GetSector(this.Location).Active
            )
                m_AI.Activate();
        ...
        public override void OnMovement(Mobile m, Point3D oldLocation)
        {
            ...
            if (
                ...
                && m.Player
                && m_FightMode != FightMode.Aggressor
                && m_FightMode != FightMode.None
                && Combatant == null
                && !Controlled
                && !Summoned
            )
            {
                ...
                if (
                    InRange(m.Location, 18)
                    && !InRange(oldLocation, 18)
                    && IsEnemy(m)
                    && CanSee(m)
                    && InLOS(m)
                )
        ...
        public bool PackArmor(int minLevel, int maxLevel, double chance)
        {
            ...
            if (item is BaseArmor)
            {
                ...
                item.Name = LootPackEntry.MagicItemName(
                    item,
                    this,
        ...
        public static void GetRandomAOSStats(
            int minLevel,
            int maxLevel,
        ...
        public bool PackWeapon(int minLevel, int maxLevel, double chance)
        {
            ...
            else
            {
                ...
                weapon.DurabilityLevel = (WeaponDurabilityLevel)RandomMinMaxScaled(
                    minLevel,
                    maxLevel
                );
        ...
        public void PackNecroReg(int min, int max)
        {
            ...
            else
            {
                ...
                if (Server.Misc.Worlds.IsOnSpaceship(this.Location, this.Map))
                {
                    Server.Misc.MorphingTime.MakeSpaceAceItem(wizreg, this);
                }
        ...
        private class DeathAdderCharmTarget : Target
        {
            ...
            {
                if (
                    !m_Charmed.DeathAdderCharmable
                    || m_Charmed.Combatant != null
                    || !from.CanBeHarmful(m_Charmed, false)
                )
                    return;
        ...
        public override bool OnBeforeDeath()
        {
            ...
            //    !this.IsBonded
            //    && (
            //        slayer is BasePerson
            //        || (
            //            slayer is BaseCreature && ((BaseCreature)slayer).FightMode == FightMode.Evil
            //        )
            //    )
            //)
            //{
            ...
            //    else if (
            //        slayer is BaseCreature
            //        && ((BaseCreature)slayer).ControlMaster != null
            //        && ((BaseCreature)slayer).Controlled
            //    ) { }
            //    else
            //    {
            //        this.Delete();
            ...
            if (slayer is PlayerMobile)
            {
                ...
                if (SeaEnemy())
                    Server.Engines.Harvest.Fishing.SailorSkill(
                        slayer,
                        (int)(IntelligentAction.GetCreatureLevel(this) / 10)
                    );

                if (
                    reg.IsPartOf(typeof(NecromancerRegion))
                    && GetPlayerInfo.EvilPlayer(slayer)
                    && slayer.Skills[SkillName.Necromancy].Base >= 25
                )
                {
                ...
                if (slayer.Skills[SkillName.Forensics].Value >= Utility.RandomMinMax(30, 150))
                {
                    if (
                        this is MummyGiant
                        || this is FleshGolem
                        || this is ReanimatedDragon
                        || this is AncientFleshGolem
                        || this is SkinGolem
                        || this is Ghoul
                        || this is AquaticGhoul
                        || this is DiseasedMummy
                        || this is Mummy
                        || this is MummyLord
                        || this is RottingCorpse
                        || this is WalkingCorpse
                        || this is ZombieGiant
                        || this is FrozenCorpse
                        || this is ZombieGargoyle
                        || this is SeaZombie
                        || this is ZombieMage
                        || this is Zombie
                    )
            ...
            if (
                vampAnimal.Slays(this)
                || vampAvian.Slays(this)
                || vampRepond.Slays(this)
                || vampGiant.Slays(this)
            )
            {
                ...
                if (
                    vampire is PlayerMobile
                    && Server.Items.BaseRace.BloodDrinker(vampire.RaceID)
                    && Utility.RandomBool()
                )
                {
                    ...
                    vampire is PlayerMobile
                    && Server.Items.BaseRace.BrainEater(vampire.RaceID)
                    && Utility.RandomBool()
                )
                {
            ...
            )
            {
                ...
                if (FeatherGetter is PlayerMobile)
                {
                    ...
                    if (
                        RangerBook != null
                        && (
                            FeatherGetter.Skills[SkillName.Camping].Base >= 90
                            || FeatherGetter.Skills[SkillName.Tracking].Base >= 90
                        )
                    )
                    {
                        int FeatherChance = 5;
                        ...
                        if (FeatherChance >= Utility.RandomMinMax(1, 100))
                        {
                            ...
                            FeatherGetter.PrivateOverheadMessage(
                                MessageType.Regular,
                                1150,
                                false,
                                "The goddess has given you golden feathers.",
                                FeatherGetter.NetState
                            );
                        }
                    }
                }
            ...
            if (!Summoned && !NoKillAwards && !IsBonded && treasureLevel >= 0)
            {
                ...
                {
                    PackItem(
                        new TreasureMap(treasureLevel, this.Map, this.Location, this.X, this.Y)
                    );
                }
            }
        ...
        public static List<DamageStore> GetLootingRights(
        ...
        )
        {
            ...
            if (
                creature is SummonedAirElemental
        ...
        {
            get { return (Summoned || DispelDifficulty > 0) && !IsAnimatedDead; }
        }
        ...
        public virtual void HealStart(Mobile patient)
        {
            ...
            m_HealTimer = Timer.DelayCall(
                TimeSpan.FromSeconds(seconds),
                new TimerStateCallback(Heal_Callback),
                patient
            );
        }
        ...
        public virtual void Heal(Mobile patient)
        {
            if (
                ...
                || !CanBeBeneficial(patient, true, true)
                || patient.Map != this.Map
            ...
            if (
                (onSelf && HealFully && Hits >= HealTrigger * HitsMax && Hits < HitsMax)
                || (
                    !onSelf
                    && HealOwnerFully
                    && patient.Hits >= HealOwnerTrigger * patient.HitsMax
        ...
        public virtual void OnThink()
        {
            ...
            if (
                ...
                || this is HenchmanWizard
                || this is HenchmanArcher
                || MyServerSettings.FastFriends(this)
            )
            {
                ...
                {
                    if (
                        Server.Misc.MyServerSettings.NoMountsInCertainRegions()
                        && Server.Mobiles.AnimalTrainer.IsNoMountRegion(
                            leader,
                            Region.Find(leader.Location, leader.Map)
                        )
                    )
                    {
            ...
            if (
                ...
                && !Summoned
                && !Controlled
                && DateTime.Now >= m_NextRummageTime
            )
            {
                double min,
                    max;
            ...
            if (CanBreath && DateTime.Now >= m_NextBreathTime) // tested: controlled dragons do breath fire, what about summoned skeletal dragons?
            {
                ...
                if (
                    ...
                    && target.Map == this.Map
                    && !IsDeadBondedPet
                    && target.InRange(this, BreathRange)
                    && InLOS(target)
                    && !BardPacified
                )
                {
                    ...
                    m_NextBreathTime =
                        ...
                        + TimeSpan.FromSeconds(
                            BreathMinDelay + (Utility.RandomDouble() * BreathMaxDelay)
                        );
                }
            }
            ...
            if ((CanHeal || CanHealOwner) && Alive && !IsHealing && !BardPacified)
            {
                ...
                if (
                    owner != null
                    && CanHealOwner
                    && DateTime.Now >= m_NextHealOwnerTime
                    && CanBeBeneficial(owner, true, true)
                    && owner.Map == this.Map
                    && InRange(owner, HealStartRange)
                    && InLOS(owner)
                ...
                )
                {
                    ...
                    CanHeal
                    && DateTime.Now >= m_NextHealTime
                    && CanBeBeneficial(this)
            ...
            if (
                ...
                && !Hidden
                && !Server.Mobiles.BasePirate.IsSailor(this)
            ) // DIVE UNDER WATER AND WAIT FOR VICTIM
            {
                bool dive = true;
                ...
                if (dive)
                {
                    Point3D loc = Server.Misc.Worlds.GetBoatWater(
                        this.X,
                        this.Y,
                        this.Z,
                        this.Map,
                ...
                Server.Misc.MyServerSettings.LineOfSight(this, false)
                && !Controlled
                && Combatant == null
                && WhisperHue != 999
                && WhisperHue != 666
            ) // MOVE FROM PLAYER SIGHT WHEN NOT SEEN
            {
                bool seeing = true;
                ...
                foreach (NetState state in NetState.Instances)
                {
                    ...
                    if (
                        (m is PlayerMobile || (m is BaseCreature && ((BaseCreature)m).Controlled))
                        && !IsCitizen()
                        && !Server.Misc.IntelligentAction.IsHiding(this)
                        && InLOS(m)
                        && m.Map == this.Map
                    )
                    {
        ...
        public void Provoke(Mobile master, Mobile target, bool bSuccess)
        {
            ...
            if (bSuccess)
            {
                ...
                if (target is BaseCreature)
                {
                    ...
                    if (
                        t.Unprovokable
                        || (t.IsParagon && BaseInstrument.GetBaseDifficulty(t) >= 160.0)
                    )
                        return;
        ...
        {
            get { return (this.CurrentWayPoint == null); }
