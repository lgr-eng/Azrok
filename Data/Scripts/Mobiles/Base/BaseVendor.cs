...
namespace Server.Mobiles
{
    ...
    public abstract class BaseVendor : BaseCreature, IVendor
    {
                    ...
                    if (((Core.SE) ? totalMinutes == 0 : totalHours == 0))
                    {
                        ...
                        if (Core.AOS)
                        {
                            ...
                            if (bulkOrder is LargeBOD)
                                m_From.SendGump(
                                    new LargeBODAcceptGump(m_From, (LargeBOD)bulkOrder)
                                );
                            else if (bulkOrder is SmallBOD)
                                m_From.SendGump(
                                    new SmallBODAcceptGump(m_From, (SmallBOD)bulkOrder)
                                );
                        }
                    }
                    else
        ...
        public BaseVendor(string title)
            : base(AIType.AI_Melee, FightMode.Closest, 15, 1, 0.1, 0.2)
        {
            LoadSBInfo();
        ...
        public static void DoJokes(Mobile m)
        {
            ...
            {
                case 0:
                    m.Say("Why did the king go to the dentist? To get his teeth crowned.");
                    break;
                case 1:
                    m.Say(
                    ...
                    break;
                case 2:
                    m.Say("What do you call a mosquito in a tin suit? A bite in shining armor.");
                    break;
                case 3:
                    m.Say(
                ...
                case 4:
                    m.Say(
                        "What king was famous because he spent so many nights at his Round Table writing books? King Author!"
                    );
                    break;
                case 5:
                    m.Say("How do you find a princess? You follow the foot prince.");
                    break;
                case 6:
                    m.Say(
                        "Why were the early days called the dark ages? Because there were so many knights!"
                    );
                    break;
                case 7:
                    m.Say("Why did Arthur have a round table? So no one could corner him!");
                    break;
                case 8:
                    m.Say("Who invented King Arthur's round table? Sir Cumference!");
                    break;
                case 9:
                    m.Say(
                        "Why did the knight run about shouting for a tin opener? He had a bee in his suit of armor!"
                    );
                    break;
                case 10:
                    m.Say("What was Camelot famous for? It's knight life!");
                    break;
                case 11:
                    m.Say(
                        "What did the toad say when the princess would not kiss him? Warts the matter with you?"
                    );
                    break;
                case 12:
                    m.Say(
                        "What do you call the young royal who keeps falling down? Prince Harming!"
                    );
                    break;
                case 13:
                    m.Say("What do you call a cat that flies over the castle wall? A cat-a-pult!");
                    break;
                case 14:
                    m.Say("What game do the fish play in the moat? Trout or dare!");
                    break;
                case 15:
                    m.Say(
                        "What did the fish say to the other when the horse fell in the moat? See horse!"
                    );
                    break;
                case 16:
                    m.Say(
                        "What do you call an angry princess just awakened from a long sleep? Slapping beauty!"
                    );
                    break;
                case 17:
                    m.Say(
                        "How did the prince get into the castle when the drawbridge was broken? He used a rowmoat!"
                    );
                    break;
                case 18:
                    m.Say(
                ...
                case 19:
                    m.Say(
                        "Why did the dinosaur live longer than the dragon? Because it didn’t smoke!"
                    );
                    break;
                case 20:
                    m.Say(
                        "What did the dragon say when it saw the Knight? 'Not more tinned food!'"
                    );
                    break;
                case 21:
                    m.Say("What do you do with a green dragon? Wait until it ripens!");
                    break;
                case 22:
                    m.PlaySound(m.Female ? 780 : 1051);
                    m.Say("*claps*");
                    break;
                case 23:
                    m.Say("*bows*");
                    ...
                    break;
                case 24:
                    m.PlaySound(m.Female ? 794 : 1066);
                    m.Say("*giggles*");
                    break;
                case 25:
                    m.PlaySound(m.Female ? 801 : 1073);
                    m.Say("*laughs*");
                    break;
                case 26:
                    m.PlaySound(792);
                    m.Say("*sticks out tongue*");
                    break;
                case 27:
        ...
        public override void OnThink()
        {
            bool ran = false;
            if (
                DateTime.Now >= m_NextAction
                && (this is Jester || (this.Location == this.Home && this.RangeHome == 0))
            )
            {
                int range = 1;
                ...
                if (this is Jester)
                {
                    DoJokes(this);
                    m_NextAction = (
                        DateTime.Now + TimeSpan.FromSeconds(Utility.RandomMinMax(25, 35))
                    );
                    ran = true;
                }
                else
        ...
        public override void OnAfterSpawn()
        {
            ...
            if (
                (
                    reg.Name == "the Basement"
                    || reg.Name == "the Dungeon Room"
                    || reg.Name == "the Camping Tent"
                )
                && this is Provisioner
            )
            {
            ...
            {
                if (this is Provisioner && reg.Name != "the Port")
                {
                    this.Title = "the dock worker";
                    if (Utility.RandomBool())
                    {
                        this.Title = "the merchant";
                    }
                }
                else if (this is Fisherman && reg.Name != "the Port")
                {
                    this.Title = "the sailor";
                }
                else if (this is Carpenter && reg.Name != "the Port")
                {
                    this.Title = "the cooper";
                }
                else if (this is Waiter)
                {
                    this.Title = "the cabin boy";
                    if (this.Female)
                    {
                        this.Title = "the serving wench";
                    }
                }
                else if (this is Weaponsmith && reg.Name != "the Port")
                {
                    this.Title = "the master-at-arms";
                }
                else if (this is Ranger)
                {
                    ...
                    if (this.FindItemOnLayer(Layer.Helm) != null)
                    {
                        this.FindItemOnLayer(Layer.Helm).Delete();
                    }
                    if (this.FindItemOnLayer(Layer.Helm) != null)
                    {
                        this.FindItemOnLayer(Layer.Helm).Delete();
                    ...
                    if (Utility.RandomBool())
                    {
                        this.AddItem(new SkullCap(Utility.RandomDyedHue()));
                    }
                    this.AddItem(new Harpoon());
                }
                else if (this is Shipwright && reg.Name != "the Port")
                {
                    this.Title = "the boatswain";
                }
            ...
            {
                if (this is Provisioner)
                {
                    this.Title = "the quartermaster";
                }
                else if (this is Waiter)
                {
                    this.Title = "the cabin boy";
        ...
        public override void OnGaveMeleeAttack(Mobile defender)
        {
            switch (Utility.Random(4))
            {
                case 0:
                    ...
                    break;
                case 1:
                    Say("" + defender.Name + ", we have heard of you!");
                    break;
                case 2:
                    Say("We have been told to watch for you, " + defender.Name + "!");
                    break;
                case 3:
                    Say("Guards, " + defender.Name + " is here!");
                    break;
            }
            ;
        }
                ...
                foreach (IShopSellInfo ssi in info)
                {
                    ...
                    foreach (Item item in items)
                    {
                        ...
                        if (item.IsStandardLoot() && item.Movable && ssi.IsSellable(item))
                        {
                            ...
                            if (
                                barter < 100
                                && this.NpcGuild != NpcGuild.None
                                && this.NpcGuild == pm.NpcGuild
                            )
                            {
                                barter = 100;
                                GuildMember = 1;
                            ...
                            table[item] = new SellItemState(
                                item,
                                ssi.GetSellPriceFor(item, barter),
                                ssi.GetNameFor(item)
                            );
                        }
                    }
            ...
            else
            {
                ...
                else if (dropped is BaseQuiver && (this is Bowyer || this is ArcherGuildmaster))
                {
                    ...
                    this.PrivateOverheadMessage(
                        ...
                        1153,
                        false,
                        "Let me fix that quiver for you.",
                        from.NetState
                    );
                    ...
                    (dropped is DrakkhenEggRed || dropped is DrakkhenEggBlack)
                    && (this is Druid || this is DruidTree || this is DruidGuildmaster)
                )
                {
                ...
                else if (dropped is DracolichSkull && (this is NecromancerGuildmaster))
                {
                    ...
                    dropped is DemonPrison
                    && (
                        this is NecromancerGuildmaster
                ...
                if (RelicValue > 0)
                {
                    ...
                    int gBonus = (int)
                        Math.Round(
                            ((from.Skills[SkillName.Mercantile].Value * RelicValue) / 100),
                            0
                        );
                ...
                else if (dropped is Museums && this is VarietyDealer)
                {
                    ...
                    Server.Multis.BaseBoat.isRolledCarpet(dropped)
                    && (this is Tailor || this is TailorGuildmaster)
                )
                {
                    Item carpet = null;

                    if (dropped is MagicDockedCarpetA || dropped is MagicCarpetADeed)
                    {
                        carpet = new MagicCarpetBDeed();
                    }
                    else if (dropped is MagicDockedCarpetB || dropped is MagicCarpetBDeed)
                    {
                        carpet = new MagicCarpetCDeed();
                    }
                    else if (dropped is MagicDockedCarpetC || dropped is MagicCarpetCDeed)
                    {
                        carpet = new MagicCarpetDDeed();
                    }
                    else if (dropped is MagicDockedCarpetD || dropped is MagicCarpetDDeed)
                    {
                        carpet = new MagicCarpetEDeed();
                    }
                    else if (dropped is MagicDockedCarpetE || dropped is MagicCarpetEDeed)
                    {
                        carpet = new MagicCarpetFDeed();
                    }
                    else if (dropped is MagicDockedCarpetF || dropped is MagicCarpetFDeed)
                    {
                        carpet = new MagicCarpetGDeed();
                    }
                    else if (dropped is MagicDockedCarpetG || dropped is MagicCarpetGDeed)
                    {
                        carpet = new MagicCarpetHDeed();
                    }
                    else if (dropped is MagicDockedCarpetH || dropped is MagicCarpetHDeed)
                    {
                        carpet = new MagicCarpetIDeed();
                    }
                    else if (dropped is MagicDockedCarpetI || dropped is MagicCarpetIDeed)
                    {
                        carpet = new MagicCarpetADeed();
                    }
                    ...
                    dropped is Gold
                    && dropped.Amount == 1000
                    && (this is Mapmaker || this is CartographersGuildmaster)
                )
                {
                    if (
                    ...
                    dropped is DugUpCoal
                    && this is Blacksmith
                    && Server.Misc.Worlds.GetMyWorld(from.Map, from.Location, from.X, from.Y)
                        == "the Savaged Empire"
                )
                {
                    string sMessage = "";
                ...
                )
                {
                    ...
                    (dropped is DDCopper || dropped is DDSilver)
                ...
                )
                {
                    ...
                    string sMessage =
                        "Sorry, you do not have enough here to exchange for even a single gold coin.";
                ...
                else if ((dropped is DDGoldNuggets) && (this is Minter || this is Banker))
                {
                    ...
                    this is ThiefGuildmaster
                    && pm.NpcGuild == NpcGuild.ThievesGuild
                    && ( // TOMB RAIDING
                ...
                )
                {
                    ...
                    switch (Utility.RandomMinMax(0, 9))
                    {
                        case 0:
                            sMessage =
                                "Hmmmm...someone has been busy. Here is "
                                + TombRaid.ToString()
                                + " gold for you.";
                            break;
                        case 1:
                            sMessage =
                                "I'll take that. Here is " + TombRaid.ToString() + " gold for you.";
                            break;
                        case 2:
                            sMessage =
                                "I assume the traps were well avoided? Here is "
                                + TombRaid.ToString()
                                + " gold for you.";
                            break;
                        case 3:
                            sMessage =
                                "You are better than some of the thieves I have met. Here is "
                                + TombRaid.ToString()
                                + " gold for you.";
                            break;
                        case 4:
                            sMessage =
                                "This is a good one you stole here. Here is "
                                + TombRaid.ToString()
                                + " gold for you.";
                            break;
                        case 5:
                            sMessage =
                                "Keep this up and we will both be rich. Here is "
                                + TombRaid.ToString()
                                + " gold for you.";
                            break;
                        case 6:
                            sMessage =
                                "How did you manage to steal this one? Here is "
                                + TombRaid.ToString()
                                + " gold for you.";
                            break;
                        case 7:
                            sMessage =
                                "You seem to be avoiding the dangers out there. Here is "
                                + TombRaid.ToString()
                                + " gold for you.";
                            break;
                        case 8:
                            sMessage =
                                "I haven't seen one like this before. Here is "
                                + TombRaid.ToString()
                                + " gold for you.";
                            break;
                        case 9:
                            sMessage =
                                "Why earn when you can take? Here is "
                                + TombRaid.ToString()
                                + " gold for you.";
                            break;
                    }
                ...
                else if (dropped is Item && !(dropped is Gold) && this is Thief)
                {
                    ...
                    {
                        int gBonus = (int)
                            Math.Round(((from.Skills[SkillName.Mercantile].Value * 500) / 100), 0);
                        if (this.NpcGuild != NpcGuild.None && this.NpcGuild == pm.NpcGuild)
                        {
                        ...
                        if (BeggingPose(from) > 0 && GuildMember == 0) // LET US SEE IF THEY ARE BEGGING
                        {
                            ...
                            from.Say(BeggingWords());
                            gBonus = (int)
                                Math.Round(((from.Skills[SkillName.Begging].Value * 500) / 100), 0);
                        }
                        gBonus = gBonus + 500;
                        from.AddToBackpack(new Gold(gBonus));
                        string sMessage = "";
                        switch (Utility.RandomMinMax(0, 9))
                        {
                            ...
                            case 8:
                                sMessage =
                                    "I have seen one like this before. Here is "
                                    + gBonus.ToString()
                                    + " gold for you.";
                                break;
                            case 9:
                    ...
                    else if (dropped is StolenChest)
                    {
                        ...
                        int gBonus = (int)
                            Math.Round(
                                ((from.Skills[SkillName.Mercantile].Value * vRipoff) / 100),
                                0
                            );
                        if (this.NpcGuild != NpcGuild.None && this.NpcGuild == pm.NpcGuild)
                        {
                        ...
                        if (BeggingPose(from) > 0 && GuildMember == 0) // LET US SEE IF THEY ARE BEGGING
                        {
                            ...
                            gBonus = (int)
                                Math.Round(
                                    ((from.Skills[SkillName.Begging].Value * vRipoff) / 100),
                                    0
                                );
                        }
                    ...
                    (
                        dropped is HenchmanFighterItem
                        || dropped is HenchmanArcherItem
                ...
                )
                {
                    ...
                    (dropped is SewageItem || dropped is SlimeItem)
                    && (
                        this is InnKeeper
                        || this is TavernKeeper
                        || this is Barkeeper
                        || this is Waiter
                    )
                )
                ...
                if (dropped is SmallBOD || dropped is LargeBOD)
                {
                    ...
                    if (!IsValidBulkOrder(dropped) || !SupportsBulkOrders(from))
                    {
                        ...
                        (dropped is SmallBOD && !((SmallBOD)dropped).Complete)
                    ...
                    if (Core.ML)
                    {
                        ((PlayerMobile)from).NextBODTurnInTime =
                            DateTime.Now + TimeSpan.FromSeconds(10.0);
                    }
        ...
        private void ProcessValidPurchase(
            int amount,
            IBuyItemInfo bii,
            Mobile buyer,
            Container cont
                        ...
                        foreach (IShopSellInfo ssi in info)
                        {
                            if (ssi.IsSellable(item))
                            {
                                if (ssi.IsResellable(item))
                                {
                                    ...
                                    if (buyItem is Spear)
                                    {
                                        buyItem.ItemID = 0xF62;
                                    }
                                    else if (buyItem is Club)
                                    {
                                        buyItem.ItemID = 0x13B4;
                                    }
                                    else if (buyItem is Cleaver)
                                    {
                                        buyItem.ItemID = 0xEC3;
                                    }
            ...
            if (fullPurchase)
            {
                if (buyer.AccessLevel >= AccessLevel.GameMaster)
                    ...
                    SayTo(
                        buyer,
                        true,
                        "The total of thy purchase is {0} gold.  My thanks for the patronage.",
                        totalCost
                    );
            }
            else
        ...
        public virtual bool OnSellItems(Mobile seller, List<SellItemResponse> list)
        {
            ...
            {
                if (
                    resp.Item.RootParent != seller
                    || resp.Amount <= 0
                    || !resp.Item.IsStandardLoot()
                    || !resp.Item.Movable
                    || (resp.Item is Container && ((Container)resp.Item).Items.Count != 0)
                )
                    continue;
            ...
            if (
                ...
                || (
                    ...
                    && (
                        ...
                        || this is DruidTree
                        || this is Druid
                        || this is DruidGuildmaster
                    )
                )
                || (
                    from.Skills[SkillName.Alchemy].Value >= 50
                    && (this is Alchemist || this is AlchemistGuildmaster)
                )
                || (
                    from.Skills[SkillName.Blacksmith].Value >= 50
                    && (this is Blacksmith || this is BlacksmithGuildmaster)
                )
                || (
                    from.Skills[SkillName.Bowcraft].Value >= 50
                    && (this is Bowyer || this is ArcherGuildmaster)
                )
                || (
                    from.Skills[SkillName.Carpentry].Value >= 50
                    && (this is Carpenter || this is CarpenterGuildmaster)
                )
                || (
                    from.Skills[SkillName.Cartography].Value >= 50
                    && (this is Mapmaker || this is CartographersGuildmaster)
                )
                || (
                    from.Skills[SkillName.Cooking].Value >= 50
                    && (this is Cook || this is Baker || this is CulinaryGuildmaster)
                )
                || (
                    from.Skills[SkillName.Inscribe].Value >= 50
                    && (this is Scribe || this is Sage || this is LibrarianGuildmaster)
                )
                || (
                    from.Skills[SkillName.Tailoring].Value >= 50
                    && (
                        this is Weaver
                        || this is Tailor
                        || this is LeatherWorker
                        || this is TailorGuildmaster
                    )
                )
                || (
                    from.Skills[SkillName.Tinkering].Value >= 50
                    && (this is Tinker || this is TinkerGuildmaster)
                )
            )
            {
...
namespace Server.ContextMenus
{
    public class SetupShoppeEntry : ContextMenuEntry
    {
        ...
        public SetupShoppeEntry(Mobile from, BaseVendor vendor)
            : base(6164, 3)
        {
            m_Vendor = vendor;
            m_From = from;
