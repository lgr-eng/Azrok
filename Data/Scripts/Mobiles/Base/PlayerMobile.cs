...
namespace Server.Mobiles
{
    ...
    public class PlayerMobile : Mobile, IHonorTarget
    {
        ...
        */
        ...
        private int m_GuildMessageHue,
            m_AllianceMessageHue;
                    ...
                    if (kvp.Value > 0)
                    {
                        ...
                        if (ammo != null)
                        {
                            ...
                            SendLocalizedMessage(
                                1073504,
                                String.Format("{0}\t{1}", ammo.Amount, name)
                            ); // You recover ~1_NUM~ ~2_AMMO~.
                        }
                    }
                }
        ...
        public override bool OnDroppedItemToWorld(Item item, Point3D location)
        {
            ...
            if (bi != null)
            {
                ...
                if (
                    type.IsDefined(typeof(FurnitureAttribute), true)
        ...
        public static void Initialize()
        {
            if (FastwalkPrevention)
                PacketHandlers.RegisterThrottler(
                    0x02,
                    new ThrottlePacketCallback(MovementThrottle_Callback)
                );
        ...
        private static void CheckPets()
        {
            foreach (Mobile m in World.Mobiles.Values)
            {
                if (m is PlayerMobile)
                {
                    ...
                    if (
                        (
                            (!pm.Mounted || (pm.Mount != null && pm.Mount is EtherealMount))
        ...
        public override void OnSkillInvalidated(Skill skill)
        {
            ...
            if (
                ...
                || skill.SkillName == SkillName.Veterinary
                || skill.SkillName == SkillName.Druidism
                || skill.SkillName == SkillName.Taming
            )
                UpdateFollowers();

            if (
                (skill.SkillName == SkillName.Necromancy)
                && (this.Hue == 0x47E)
                && (this.Skills[SkillName.Necromancy].Base < 100)
            )
            {
        ...
        {
            if (
                (this.Skills[SkillName.Herding].Base >= 120.0)
                && (this.Skills[SkillName.Veterinary].Base >= 120.0)
                && (this.Skills[SkillName.Druidism].Base >= 120.0)
                && (this.Skills[SkillName.Taming].Base >= 120.0)
            )
                this.FollowersMax = 8;
            else if (
                (this.Skills[SkillName.Herding].Base >= 90)
                && (this.Skills[SkillName.Veterinary].Base >= 90)
                && (this.Skills[SkillName.Druidism].Base >= 90)
                && (this.Skills[SkillName.Taming].Base >= 90)
            )
                this.FollowersMax = 7;
            else if (
                (this.Skills[SkillName.Herding].Base >= 60)
                && (this.Skills[SkillName.Veterinary].Base >= 60)
                && (this.Skills[SkillName.Druidism].Base >= 60)
                && (this.Skills[SkillName.Taming].Base >= 60)
            )
                this.FollowersMax = 6;
            else
                this.FollowersMax = 5;
        ...
        public override int GetMaxResistance(ResistanceType type)
        {
            ...
            if (
                ...
                && 60 < max
                && Spells.Fourth.CurseSpell.UnderEffect(this)
            )
                max = 60;
            ...
            if (
                type == ResistanceType.Physical
                && Spells.Research.ResearchRockFlesh.UnderEffect(this)
            )
                max = 90;
            ...
            if (AccountHandler.LockdownLevel > AccessLevel.Player)
            {
                ...
                if (acct == null || !acct.HasAccess(from.NetState))
                {
                    ...
                    Timer.DelayCall(
                        ...
                        new TimerStateCallback(Disconnect),
                        from
                    );
                }
                ...
                {
                    notice =
                        "The server is currently under lockdown. You have sufficient access level to connect.";
                }

                from.SendGump(
                    new NoticeGump(1060637, 30720, notice, 0xFFC000, 300, 140, null, null)
                );
                return;
            }
                ...
                for (int i = items.Count - 1; i >= 0; --i)
                {
                    ...
                    if (item is BaseWeapon)
                    {
                        ...
                        if (dex < weapon.DexRequirement)
                            ...
                            str < AOS.Scale(weapon.StrRequirement, 100 - weapon.GetLowerStatReq())
                        )
                            drop = true;
                    ...
                    else if (item is BaseClothing)
                    {
                        ...
                        )
                        {
                            ...
                            clothing.RequiredRace != null
                            && clothing.RequiredRace != this.Race
                        )
                        {
                            drop = true;
                        }
            ...
            if (AccessLevel < AccessLevel.GameMaster && item.IsChildOf(this.Backpack))
            {
                ...
                if (curWeight > maxWeight)
                    this.SendLocalizedMessage(
                        1019035,
                        true,
                        String.Format(" : {0} / {1}", curWeight, maxWeight)
                    );
            }
        ...
        {
            if (
                m_DesignContext != null
                || (target is PlayerMobile && ((PlayerMobile)target).m_DesignContext != null)
            )
                return false;
        ...
        public override int HitsMax
        {
            get
            {
                ...
                if (
                    AnimalForm.UnderTransformation(this, typeof(MysticalFox))
                ...
                if (Alive && InsuranceEnabled)
                {
                    ...
                    if (AutoRenewInsurance)
                        list.Add(
                            new CallbackEntry(
                                6202,
                                new ContextCallback(CancelRenewInventoryInsurance)
                            )
                        );
                    else
                        list.Add(
                            new CallbackEntry(
                                6200,
                                new ContextCallback(AutoRenewInventoryInsurance)
                            )
                        );
                }
        ...
        {
            if (
                ((item is Container) && !(item is BaseQuiver))
            ...
            if (
                (item is Spellbook && item.LootType == LootType.Blessed)
                || item is PotionKeg
                || item is Sigil
            )
                return false;
        ...
        private void GetVendor()
        {
            ...
            if (
                ...
                && house != null
                && house.IsOwner(this)
                && house.InternalizedVendors.Count > 0
            )
            {
        ...
        protected override void OnLocationChange(Point3D oldLocation)
        {
            ...
            if (
                !(
                    Server.Misc.Worlds.IsMainRegion(
                        Server.Misc.Worlds.GetRegionName(this.Map, oldLocation)
                    )
                )
                && Server.Misc.Worlds.IsMainRegion(
            ...
            )
            {
                ...
                (
                    Server.Misc.MyServerSettings.NoMountBuilding()
            ...
            if (Server.Mobiles.AnimalTrainer.IsBeingFast(this) && !mountAble)
            {
                ...
                {
                    if (
                        !Server.Mobiles.AnimalTrainer.AllowMagicSpeed(
                            this,
                            Region.Find(this.Location, this.Map)
                        )
                    )
                    {
                        ...
                        )
                        {
                            ...
                            {
                                this.SendMessage(
                                    "These shoes seem to have their magic diminished here."
                                );
                            }
                        }
        ...
        {
            // Allow movement through your own followers
            if (
                shoved is BaseCreature
                && ((BaseCreature)shoved).Controlled
                && ((BaseCreature)shoved).ControlMaster == this
            )
            {
                return true;
            }

            // Allow movement through Moon Mouse at Moongates
            if (shoved is MoonCritter)
            {
                return true;
            }
        ...
        protected override void OnMapChange(Map oldMap)
        {
            ...
            if (
                (Map != Faction.Facet && oldMap == Faction.Facet)
                || (Map == Faction.Facet && oldMap != Faction.Facet)
            )
                InvalidateProperties();
        ...
        public override void Resurrect()
        {
            ...
            {
                case 0:
                    LoggingFunctions.LogStandard(this, "has returned from the realm of the dead");
                    break;
                case 1:
                    LoggingFunctions.LogStandard(
                        this,
                        "was brought back to the world of the living"
                    );
                    break;
                case 2:
                    LoggingFunctions.LogStandard(this, "has been restored to life");
                    break;
                case 3:
                    LoggingFunctions.LogStandard(this, "has been brought back from the grave");
                    break;
                case 4:
                    LoggingFunctions.LogStandard(this, "has been resurrected to this world");
                    break;
                case 5:
                    LoggingFunctions.LogStandard(this, "has returned to life after death");
                    break;
                case 6:
                    LoggingFunctions.LogStandard(
                        this,
                        "was resurrected for another chance at life"
                    );
                    break;
            }
        ...
        {
            // Console.WriteLine("[DEBUG] OnBeforeDeath called for {0}", this.Name);

            // Console.WriteLine("[DEBUG] Checking if guards killed {0}", this.Name);
            if (
                !Server.Misc.MyServerSettings.GuardsSentenceDeath()
                && (
                    this.LastKiller is TownGuards
                    || (
                        this.LastKiller is BaseVendor
                        && this.LastKiller.WhisperHue != 999
                        && !(this.LastKiller is PlayerVendor)
                        && !(this.LastKiller is PlayerBarkeeper)
                    )
                )
            )
            {
                ...
                if (
                    this.RaceID > 0
                    && Server.Items.BaseRace.IsEvilDemonCreature(this)
                    && world == "the Serpent Island"
                    && !PlayerSettings.GetDiscovered(this, "the Serpent Island")
                )
                {
            ...
            // Console.WriteLine("[DEBUG] Checking if {0} has a Jewel or Gem of Immortality", this.Name);
            ...
            // Console.WriteLine("[DEBUG] Checking if {0} is possessing/controlling another creature", this.Name);
            bool uncontrolled = Server.Commands.CloneCommands.UncontrolDeath((Mobile)this);

            if (!uncontrolled) // If the player was possessing/controlling another creature
            {
                return false; // Prevent the player's death
            }

            NetState state = NetState;

            // Console.WriteLine("[DEBUG] Canceling all of {0}'s trades", this.Name);
            if (state != null)
            ...
            if (this.Young)
            {
                if (YoungDeathTeleport())
                    Timer.DelayCall(
                        ...
                        new TimerCallback(SendYoungDeathNotice)
                    );
            }
        ...
        public override void DoSpeech(string text, int[] keywords, MessageType type, int hue)
        {
            if (
                ...
                && (type == MessageType.Guild || type == MessageType.Alliance)
            )
            {
        ...
        public override void Damage(int amount, Mobile from)
        {
            ...
            if (oath == this)
            {
                ...
                {
                    from.Damage(
                        (int)(amount * (1 - (((from.Skills.MagicResist.Value * .5) + 10) / 100))),
                        this
                    );
                }
                else
        ...
        {
            get { return CharacterDiscovered; }
            set
            {
                CharacterDiscovered = value;
                InvalidateProperties();
            }
        }
        ...
        {
            get { return CharacterSheath; }
            set
            {
                CharacterSheath = value;
                InvalidateProperties();
            }
        }
        ...
        {
            get { return CharacterGuilds; }
            set
            {
                CharacterGuilds = value;
                InvalidateProperties();
            }
        }
        ...
        {
            get { return CharacterBoatDoor; }
            set
            {
                CharacterBoatDoor = value;
                InvalidateProperties();
            }
        }
        ...
        {
            get { return CharacterPublicDoor; }
            set
            {
                CharacterPublicDoor = value;
                InvalidateProperties();
            }
        }
        ...
        {
            get { return CharacterBegging; }
            set
            {
                CharacterBegging = value;
                InvalidateProperties();
            }
        }
        ...
        {
            get { return CharacterWepAbNames; }
            set
            {
                CharacterWepAbNames = value;
                InvalidateProperties();
            }
        }
        ...
        {
            get { return CharMusical; }
            set { CharMusical = value; }
        }
        ...
        {
            get { return CharacterLoot; }
            set { CharacterLoot = value; }
        }
        ...
        {
            get { return CharacterWanted; }
            set { CharacterWanted = value; }
        }
        ...
        {
            get { return CharacterOriental; }
            set
            {
                CharacterOriental = value;
                InvalidateProperties();
            }
        }
        ...
        {
            get { return ArtifactQuestTime; }
            set
            {
                ArtifactQuestTime = value;
                InvalidateProperties();
            }
        }
        ...
        {
            get { return BardsTaleQuest; }
            set
            {
                BardsTaleQuest = value;
                InvalidateProperties();
            }
        }
        ...
        {
            get { return EpicQuestName; }
            set { EpicQuestName = value; }
        }
        ...
        {
            get { return EpicQuestNumber; }
            set
            {
                EpicQuestNumber = value;
                InvalidateProperties();
            }
        }
        ...
        [CommandProperty(AccessLevel.GameMaster)]
        public bool Using_ArchmageBook
        {
            get { return UsingAncientBook; }
            set
            {
                UsingAncientBook = value;
                InvalidateProperties();
            }
        }
        ...
        {
            get { return SpellBarsMage1; }
            set
            {
                SpellBarsMage1 = value;
                InvalidateProperties();
            }
        }
        ...
        {
            get { return SpellBarsMage2; }
            set
            {
                SpellBarsMage2 = value;
                InvalidateProperties();
            }
        }
        ...
        {
            get { return SpellBarsMage3; }
            set
            {
                SpellBarsMage3 = value;
                InvalidateProperties();
            }
        }
        ...
        {
            get { return SpellBarsMage4; }
            set
            {
                SpellBarsMage4 = value;
                InvalidateProperties();
            }
        }
        ...
        {
            get { return SpellBarsNecro1; }
            set
            {
                SpellBarsNecro1 = value;
                InvalidateProperties();
            }
        }
        ...
        {
            get { return SpellBarsNecro2; }
            set
            {
                SpellBarsNecro2 = value;
                InvalidateProperties();
            }
        }
        ...
        {
            get { return SpellBarsKnight1; }
            set
            {
                SpellBarsKnight1 = value;
                InvalidateProperties();
            }
        }
        ...
        {
            get { return SpellBarsKnight2; }
            set
            {
                SpellBarsKnight2 = value;
                InvalidateProperties();
            }
        }
        ...
        {
            get { return SpellBarsDeath1; }
            set
            {
                SpellBarsDeath1 = value;
                InvalidateProperties();
            }
        }
        ...
        {
            get { return SpellBarsDeath2; }
            set
            {
                SpellBarsDeath2 = value;
                InvalidateProperties();
            }
        }
        ...
        {
            get { return SpellBarsBard1; }
            set
            {
                SpellBarsBard1 = value;
                InvalidateProperties();
            }
        }
        ...
        {
            get { return SpellBarsBard2; }
            set
            {
                SpellBarsBard2 = value;
                InvalidateProperties();
            }
        }
        ...
        {
            get { return SpellBarsPriest1; }
            set
            {
                SpellBarsPriest1 = value;
                InvalidateProperties();
            }
        }
        ...
        {
            get { return SpellBarsPriest2; }
            set
            {
                SpellBarsPriest2 = value;
                InvalidateProperties();
            }
        }
        ...
        {
            get { return SpellBarsMonk1; }
            set { SpellBarsMonk1 = value; }
        }
        ...
        {
            get { return SpellBarsMonk2; }
            set { SpellBarsMonk2 = value; }
        }

        public string SpellBarsArch1;

        [CommandProperty(AccessLevel.GameMaster)]
        public string SpellBars_Arch1
        {
            get { return SpellBarsArch1; }
            set
            {
                SpellBarsArch1 = value;
                InvalidateProperties();
            }
        }
        ...
        [CommandProperty(AccessLevel.GameMaster)]
        public string SpellBars_Arch2
        {
            get { return SpellBarsArch2; }
            set
            {
                SpellBarsArch2 = value;
                InvalidateProperties();
            }
        }
        ...
        [CommandProperty(AccessLevel.GameMaster)]
        public string SpellBars_Arch3
        {
            get { return SpellBarsArch3; }
            set
            {
                SpellBarsArch3 = value;
                InvalidateProperties();
            }
        }
        ...
        [CommandProperty(AccessLevel.GameMaster)]
        public string SpellBars_Arch4
        {
            get { return SpellBarsArch4; }
            set
            {
                SpellBarsArch4 = value;
                InvalidateProperties();
            }
        }
        ...
        {
            get { return SpellBarsElly1; }
            set
            {
                SpellBarsElly1 = value;
                InvalidateProperties();
            }
        }
        ...
        {
            get { return SpellBarsElly2; }
            set
            {
                SpellBarsElly2 = value;
                InvalidateProperties();
            }
        }
        ...
        {
            get { return ThiefQuest; }
            set { ThiefQuest = value; }
        }
        ...
        {
            get { return KilledSpecialMonsters; }
            set { KilledSpecialMonsters = value; }
        }
        ...
        {
            get { return CharacterBarbaric; }
            set
            {
                CharacterBarbaric = value;
                InvalidateProperties();
            }
        }
        ...
        {
            get { return MagerySpellHue; }
            set
            {
                MagerySpellHue = value;
                InvalidateProperties();
            }
        }
        ...
        {
            get { return ClassicPoisoning; }
            set
            {
                ClassicPoisoning = value;
                InvalidateProperties();
            }
        }
        ...
        public override void Serialize(GenericWriter writer)
        {
            ...
            else
            {
                ...
                for (int i = 0; i < m_DoneQuests.Count; ++i)
                {
                    ...
                    QuestSerializer.Write(
                        (Type)restartInfo.QuestType,
                        QuestSystem.QuestTypes,
                        writer
                    );
            ...
            if (Map == Faction.Facet)
            {
                ...
                if (pl != null)
                {
                    ...
                    if (faction.Commander == this)
                        text = String.Concat(
                            this.Female ? "(Commanding Lady of the " : "(Commanding Lord of the ",
        ...
        private int m_HairModID = -1,
            m_HairModHue;
        private int m_BeardModID = -1,
            m_BeardModHue;
        ...
        {
            get { return m_AvailableResurrects; }
            ...
            if (m_EthicPlayer != null)
            {
                if (suffix.Length == 0)
                    ...
                    suffix = String.Concat(
                        suffix,
                        " ",
                        m_EthicPlayer.Ethic.Definition.Adjunct.String
                    );
            }
            #endregion
        ...
        {
            if (
                this.Region.IsPartOf(typeof(Jail))
