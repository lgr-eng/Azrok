...
namespace Server.Engines.BulkOrders
{
    ...
    {
        #region Constructors
        private static readonly ConstructCallback SturdyShovel = new ConstructCallback(
            CreateSturdyShovel
        );
        private static readonly ConstructCallback SturdyPickaxe = new ConstructCallback(
            CreateSturdyPickaxe
        );
        private static readonly ConstructCallback MiningGloves = new ConstructCallback(
            CreateMiningGloves
        );
        private static readonly ConstructCallback GargoylesPickaxe = new ConstructCallback(
            CreateGargoylesPickaxe
        );
        private static readonly ConstructCallback ProspectorsTool = new ConstructCallback(
            CreateProspectorsTool
        );
        private static readonly ConstructCallback PowderOfTemperament = new ConstructCallback(
            CreatePowderOfTemperament
        );
        private static readonly ConstructCallback RunicHammer = new ConstructCallback(
            CreateRunicHammer
        );
        private static readonly ConstructCallback PowerScroll = new ConstructCallback(
            CreatePowerScroll
        );
        private static readonly ConstructCallback ColoredAnvil = new ConstructCallback(
            CreateColoredAnvil
        );
        private static readonly ConstructCallback AncientHammer = new ConstructCallback(
            CreateAncientHammer
        );
        ...
        {
            if (type >= 1 && type <= 8)
                return new RunicHammer(
                    CraftResource.Iron + type,
                    Core.AOS ? (55 - (type * 5)) : 50
                );
        ...
        )
        {
            ...
            int mtrlIndex =
                (material >= BulkMaterialType.DullCopper && material <= BulkMaterialType.Valorite)
                    ? 1 + (int)(material - BulkMaterialType.DullCopper)
                    : 0;
            ...
            int money = Utility.RandomMinMax(min, max);
        ...
        public SmithRewardCalculator()
        {
            Groups = new RewardGroup[]
            {
                ...
                new RewardGroup(
                    450,
                    new RewardItem(9, PowderOfTemperament),
                    new RewardItem(1, MiningGloves, 5)
                ),
                new RewardGroup(500, new RewardItem(1, RunicHammer, 1)),
                new RewardGroup(
                    550,
                    new RewardItem(3, RunicHammer, 1),
                    new RewardItem(2, RunicHammer, 2)
                ),
    ...
    public sealed class TailorRewardCalculator : RewardCalculator
    {
        ...
        )
        {
            ...
            int mtrlIndex = (
                material == BulkMaterialType.Barbed
                    ? 3
                    : material == BulkMaterialType.Horned
                        ? 2
                        : material == BulkMaterialType.Spined
                            ? 1
                            : 0
            );
        ...
        public TailorRewardCalculator()
        {
            Groups = new RewardGroup[]
            {
                new RewardGroup(0, new RewardItem(1, TailorGuildCoin, 5)),
                new RewardGroup(50, new RewardItem(1, TailorGuildCoin, 10)),
                new RewardGroup(100, new RewardItem(1, TailorGuildCoin, 30)),
                new RewardGroup(150, new RewardItem(1, TailorGuildCoin, 60)),
                new RewardGroup(200, new RewardItem(1, TailorGuildCoin, 100)),
                new RewardGroup(300, new RewardItem(1, TailorGuildCoin, 125)),
                new RewardGroup(350, new RewardItem(1, TailorGuildCoin, 150)),
                new RewardGroup(400, new RewardItem(1, TailorGuildCoin, 160)),
                new RewardGroup(450, new RewardItem(1, TailorGuildCoin, 170)),
                new RewardGroup(500, new RewardItem(1, TailorGuildCoin, 180)),
                new RewardGroup(550, new RewardItem(1, TailorGuildCoin, 190)),
                new RewardGroup(575, new RewardItem(1, TailorGuildCoin, 200)),
                new RewardGroup(600, new RewardItem(1, TailorGuildCoin, 250)),
                new RewardGroup(650, new RewardItem(1, TailorGuildCoin, 300)),
                new RewardGroup(700, new RewardItem(1, TailorGuildCoin, 350))
            };
        }
    }
}
