...
namespace Server.Items
{
    public abstract class BaseContainer : Container
    {
        ...
        public override void OnDoubleClick(Mobile from)
        {
            if (from.AccessLevel > AccessLevel.Player || from.InRange(this.GetWorldLocation(), 2) || this.RootParent is PlayerVendor)
            {
                ...
                if (this is SmallHollowBook || this is LargeHollowBook)
                {
                    int amount = 40;
        ...
        public override void Deserialize(GenericReader reader)
        {
            ...
            else if (ItemID == 0x2B02 || ItemID == 0x2B03 || ItemID == 0x5770) { GumpID = 0x3D; DropSound = 0x48; }
            ...
            else if (this is SmallHollowBook || this is LargeHollowBook) { GumpID = 0x2A74; DropSound = 0x42; }
        }
    }
    ...
    [Flipable(0x56F9, 0x56FA, 0x56FB, 0x56FC, 0x56FD, 0x56FE, 0x56FF, 0x5700, 0x5701, 0x5702)]
    public class SmallHollowBook : BaseContainer
    {
        public string Author;
        [CommandProperty(AccessLevel.Owner)]
        public string Authors { get { return Author; } set { Author = value; InvalidateProperties(); } }

        public override int DefaultMaxWeight { get { return 40; } }
        public override int DefaultMaxItems { get { return 40; } }
        ...
        public SmallHollowBook() : base(0x56F9)
        {
            ...
            GumpID = 0x2A74;
            Author = Server.Misc.RandomThings.GetRandomAuthor();
        }

        public SmallHollowBook(Serial serial) : base(serial)
        {
        }
        ...
        public override void AddNameProperties(ObjectPropertyList list)
        {
            ...
            list.Add(1070722, "By " + Author);
        }

        public override bool OnDragDropInto(Mobile from, Item dropped, Point3D p)
        {
            if ((dropped.Weight * dropped.Amount) <= 5.0)
            {
    ...
    [Flipable(0x5703, 0x5704, 0x5705, 0x5706, 0x5707, 0x5708, 0x5709, 0x570A)]
    public class LargeHollowBook : BaseContainer
    {
        public string Author;
        [CommandProperty(AccessLevel.Owner)]
        public string Authors { get { return Author; } set { Author = value; InvalidateProperties(); } }
        ...
        public LargeHollowBook(Serial serial) : base(serial)
        {
        }
    ...
    [Flipable(0x55DD, 0x577E)]
    public class EnormousBag : BaseContainer, IDyable
    {
        [Constructable]
        ...
        public EnormousBag(Serial serial) : base(serial)
        {
        }
    ...
    public class LargeBackpack : BaseContainer, IDyable
    {
        [Constructable]
        ...
        public LargeBackpack(Serial serial) : base(serial)
        {
        }
