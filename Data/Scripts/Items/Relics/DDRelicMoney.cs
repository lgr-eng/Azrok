...
namespace Server.Items
{
    public class DDCopper : Item
    {
        ...
        [Constructable]
        public DDCopper(int amountFrom, int amountTo)
            : this(Utility.RandomMinMax(amountFrom, amountTo)) { }

        [Constructable]
        public DDCopper(int amount)
            : base(0xEF0)
        {
            Name = "copper coins";
            Hue = 0x83E;
    ...
    public class DDSilver : Item
    {
        ...
        [Constructable]
        public DDSilver(int amountFrom, int amountTo)
            : this(Utility.RandomMinMax(amountFrom, amountTo)) { }

        [Constructable]
        public DDSilver(int amount)
            : base(0xEF0)
        {
            Name = "silver coins";
            Stackable = true;
    ...
    public class DDJewels : Item
    {
        ...
        [Constructable]
        public DDJewels(int amountFrom, int amountTo)
            : this(Utility.RandomMinMax(amountFrom, amountTo)) { }

        [Constructable]
        public DDJewels(int amount)
            : base(0xEF0)
        {
            Name = "jewels";
            Stackable = true;
    ...
    public class DDXormite : Item
    {
        ...
        [Constructable]
        public DDXormite(int amountFrom, int amountTo)
            : this(Utility.RandomMinMax(amountFrom, amountTo)) { }

        [Constructable]
        public DDXormite(int amount)
            : base(0xEF0)
        {
            Name = "xormite coins";
            Stackable = true;
        ...
        public DDXormite(Serial serial)
            : base(serial) { }
    ...
    public class DDGemstones : Item
    {
        ...
        [Constructable]
        public DDGemstones(int amountFrom, int amountTo)
            : this(Utility.RandomMinMax(amountFrom, amountTo)) { }

        [Constructable]
        public DDGemstones(int amount)
            : base(0xE99)
        {
            Name = "gemstones";
            Stackable = true;
        ...
        public DDGemstones(Serial serial)
            : base(serial) { }
    ...
    public class DDGoldNuggets : Item
    {
        ...
        [Constructable]
        public DDGoldNuggets(int amountFrom, int amountTo)
            : this(Utility.RandomMinMax(amountFrom, amountTo)) { }

        [Constructable]
        public DDGoldNuggets(int amount)
            : base(0x1BC8)
        {
            Name = "gold nuggets";
            Stackable = true;
        ...
        public DDGoldNuggets(Serial serial)
            : base(serial) { }
