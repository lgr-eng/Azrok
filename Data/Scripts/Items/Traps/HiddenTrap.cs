...
namespace Server.Items
{
    public class HiddenTrap : Item
    {
        ...
        public int Hidden_TrapType
        {
            get { return HiddenTrapType; }
            set
            {
                HiddenTrapType = value;
        ...
        public HiddenTrap(Serial serial)
            : base(serial) { }
        ...
        public override bool OnMoveOver(Mobile m)
        {
            ...
            if (m is PlayerMobile)
            {
                ...
                if (nSprung == 1)
                {
                    ...
                    {
                        HiddenTrapType = Utility.RandomList(
                            1,
                            2,
                            3,
                            4,
                    ...
                    else if (nTrapType == 2 && SavingThrow(m, "Agility", true) == false) // TRIP WIRE
                    {
                        ...
                        if (HowBad == 1)
                        {
                            ...
                            {
                                textSay =
                                    "You tripped over a loose deck plate and dropped your backpack!";
                        ...
                        {
                            textSay =
                                "You tripped over a wire and dropped one of your equipped items!";
                            textLog = "a trip wire trap";

                            if (Server.Misc.Worlds.IsOnSpaceship(m.Location, m.Map))
                            {
                                textSay =
                                    "You tripped over a loose deck plate and dropped one of your equipped items!";
                                textLog = "a loose deck plate";
                            }
                    ...
                    else if (nTrapType == 3 && SavingThrow(m, "Magic", true) == false) // COINS TO LEAD TRAP
                    {
                        ...
                        {
                            textSay =
                                "You stepped over a molecular atomizer, making your coins turn to lead!";
                    ...
                    else if (nTrapType == 5 && SavingThrow(m, "Magic", true) == false) // LOSE A STAT TRAP
                    {
                        ...
                        if (nStat == 1)
                        {
                            if (m.RawStr > 10)
                            {
                                ...
                                {
                                    textSay =
                                        "You walked over some bacteria, making you feel weaker!";
                        ...
                        else if (nStat == 2)
                        {
                            if (m.RawDex > 10)
                            {
                                ...
                                {
                                    textSay =
                                        "You walked over some bacteria, making you feel sluggish!";
                                    textLog = "a bacterial contamination";
                                }
                        ...
                        else
                        {
                            if (m.RawInt > 10)
                            {
                                ...
                                {
                                    textSay =
                                        "You walked over some bacteria, making your mind cloudy!";
                                    textLog = "a bacterial contamination";
                                }
                    ...
                    else if (nTrapType == 6 && SavingThrow(m, "Poison", true) == false) // POISON TRAP
                    {
                        ...
                        {
                            textSay =
                                "You stepped on some biological contamination, making you feel ill!";
                    ...
                    else if (nTrapType == 7 && SavingThrow(m, "Magic", true) == false) // DRAIN TRAP
                    {
                        ...
                        if (nStat == 1)
                        {
                            ...
                            {
                                textSay =
                                    "You stepped over a radioactive spill, making you feel near dead!";
                        ...
                        else if (nStat == 2)
                        {
                            ...
                            {
                                textSay =
                                    "You stepped over a radioactive spill, making you feel really tired!";
                                textLog = "a radioactive spill";
                            }
                        ...
                        else
                        {
                            ...
                            {
                                textSay =
                                    "You stepped over a radioactive spill, draining your mana!";
                                textLog = "a radioactive spill";
                            }
                    ...
                    else if (nTrapType == 8 && SavingThrow(m, "Magic", true) == false) // GEM STONE TRAP
                    {
                        ...
                        foreach (Item i in m.Backpack.FindItemsByType(typeof(Ruby), true))
                        {
                            items.Add(i);
                        }
                        foreach (Item i in m.Backpack.FindItemsByType(typeof(Amber), true))
                        {
                            items.Add(i);
                        }
                        foreach (Item i in m.Backpack.FindItemsByType(typeof(Amethyst), true))
                        {
                            items.Add(i);
                        }
                        foreach (Item i in m.Backpack.FindItemsByType(typeof(Citrine), true))
                        {
                            items.Add(i);
                        }
                        foreach (Item i in m.Backpack.FindItemsByType(typeof(Emerald), true))
                        {
                            items.Add(i);
                        }
                        foreach (Item i in m.Backpack.FindItemsByType(typeof(Diamond), true))
                        {
                            items.Add(i);
                        }
                        foreach (Item i in m.Backpack.FindItemsByType(typeof(Sapphire), true))
                        {
                            items.Add(i);
                        }
                        foreach (Item i in m.Backpack.FindItemsByType(typeof(StarSapphire), true))
                        {
                            items.Add(i);
                        }
                        foreach (Item i in m.Backpack.FindItemsByType(typeof(Tourmaline), true))
                        {
                            items.Add(i);
                        }
                        foreach (Item i in m.Backpack.FindItemsByType(typeof(DDRelicGem), true))
                        {
                            items.Add(i);
                        }
                        foreach (Item i in m.Backpack.FindItemsByType(typeof(MageEye), true))
                        {
                            items.Add(i);
                        }
                        ...
                        if (nAmount > 0)
                        {
                            ...
                            {
                                textSay =
                                    "You stepped over a damaged power coil, fusing your gemstones together!";
                    ...
                    else if (nTrapType == 11 && SavingThrow(m, "Magic", true) == false) // TELEPORT TRAP
                    {
                        ...
                        {
                            textSay =
                                "You stepped over an overcharged transporter pad, transporting you away from here!";
                    ...
                    else if (nTrapType == 14 && SavingThrow(m, "Physical", true) == false) // FLOOR SPIKE TRAP
                    {
                        ...
                        m.LocalOverheadMessage(
                            ...
                            0xB1F,
                            true,
                            "You triggered a spike trap!"
                        );
                        int itHurts = (int)(
                            (Utility.RandomMinMax(50, 200) * (100 - m.PhysicalResistance)) / 100
                        );
                        m.Damage(itHurts, m);
                    ...
                    else if (nTrapType == 15 && SavingThrow(m, "Physical", true) == false) // SAW TRAP
                    {
                        ...
                        m.LocalOverheadMessage(
                            ...
                            0xB1F,
                            true,
                            "You triggered a saw blade trap!"
                        );
                        int itHurts = (int)(
                            (Utility.RandomMinMax(50, 200) * (100 - m.PhysicalResistance)) / 100
                        );
                    ...
                    else if (nTrapType == 16 && SavingThrow(m, "Fire", true) == false) // FLAME TRAP
                    {
                        ...
                        m.LocalOverheadMessage(MessageType.Emote, 0xB1F, true, textSay);
                        int itHurts = (int)(
                            (Utility.RandomMinMax(50, 200) * (100 - m.FireResistance)) / 100
                        );
                        m.Damage(itHurts, m);
                        sTrapType = textLog;
                    }
                    else if (nTrapType == 17 && SavingThrow(m, "Physical", true) == false) // GIANT SPIKE TRAP
                    {
                        ...
                        m.LocalOverheadMessage(
                            ...
                            0xB1F,
                            true,
                            "You triggered a giant spike trap!"
                        );
                        int itHurts = (int)(
                            (Utility.RandomMinMax(50, 200) * (100 - m.PhysicalResistance)) / 100
                        );
                    ...
                    else if (nTrapType == 19 && SavingThrow(m, "Energy", true) == false) // ELECTRICAL TRAP
                    {
                        ...
                        m.LocalOverheadMessage(MessageType.Emote, 0xB1F, true, textSay);
                        int itHurts = (int)(
                            (Utility.RandomMinMax(50, 200) * (100 - m.EnergyResistance)) / 100
                        );
                        m.Damage(itHurts, m);
                        sTrapType = textLog;
                    }
                    ...
                    else if (nTrapType == 21 && SavingThrow(m, "Poison", true) == false) // TAINTED TRAP
                    {
                        ...
                        if (nAmount > 0)
                        {
                            ...
                            if (nAmount > 1)
                            {
                                bandage.Name = sAmount + " tainted bandages";
                            }
                            ...
                            m.LocalOverheadMessage(
                                ...
                                0xB1F,
                                true,
                                "You walked into a noxious cloud, tainting your bandages!"
                            );
                    ...
                    else if (nTrapType == 24 && SavingThrow(m, "Agility", true) == false) // PIT TRAP
                    {
                        ...
                        ((PlayerMobile)m).CharacterPublicDoor =
                            sX + "#" + sY + "#" + sZ + "#" + sMap + "#" + sZone;
            ...
            if (
                sTrapType == "a teleportation trap"
                || sTrapType == "an overcharged transporter pad"
                || sTrapType == "a deep pit"
            )
                return false;
        ...
        public static bool SavingThrow(Mobile m, string save, bool isTrap)
        {
            ...
            if (save == "Magic")
            {
                ...
                SaveThrow = (int)(
                    (m.Int + m.Skills[SkillName.MagicResist].Value + m.EnergyResistance) / 4
                );
            }
            ...
            else if (save == "Poison")
            {
                ...
                SaveThrow = (int)(
                    (m.Str + m.Skills[SkillName.Poisoning].Value + m.PoisonResistance) / 4
                );
            }
            else if (save == "Energy")
            {
            ...
            if (SaveThrow >= Utility.RandomMinMax(1, 100))
            {
                ...
                {
                    string textSay =
                        "You got near a hidden trap, but with your " + area + "...you avoid it.";
                    if (Server.Misc.Worlds.IsOnSpaceship(m.Location, m.Map))
                    {
                        textSay =
                            "You got near something dangerous, but with your "
                            + area
                            + "...you avoid it.";
                    }
        ...
        public static bool CanSetOffTraps(Mobile m)
        {
            if (
                m is PlayerMobile
                && (!m.Alive || m.Blessed == true || m.AccessLevel > AccessLevel.Player)
            )
                return false;
        ...
        public static int CheckTrapAvoidance(Mobile m, Item Trap)
        {
            ...
            {
                trapChance = MyServerSettings.FloorTrapTrigger();
            }
            ...
            if (
                !(Trap is SpellTrap)
                && trapChance >= Utility.RandomMinMax(1, 100)
                && m is PlayerMobile
            )
            {
                nSprung = 0;
            }
            else if (m.CheckSkill(SkillName.RemoveTrap, 0, 125))
            {
                if (m is PlayerMobile)
                {
                    if (Trap is MushroomTrap)
                    {
                        m.LocalOverheadMessage(
                            ...
                            0x3B2,
                            false,
                            "You got near a strange mushroom, but your skill in removing traps has helped you avoid it."
                        );
                    }
                    else
                    {
                        textSay =
                            "You got near a hidden trap, but your skill in removing traps has helped you disable it.";
                        if (Server.Misc.Worlds.IsOnSpaceship(m.Location, m.Map))
                        {
                            textSay =
                                "You got near something dangerous, but your skill in removing traps has helped you avoid it.";
                        }
                        m.LocalOverheadMessage(Network.MessageType.Emote, 0x3B2, false, textSay);
                        m.PlaySound(0x241);
                    }
            ...
            if (m is PlayerMobile)
            {
                        ...
                        if (nPower >= Utility.RandomMinMax(1, 100) && wands.owner == m)
                        {
                            if (Trap is MushroomTrap)
                            {
                                m.LocalOverheadMessage(
                                    ...
                                    0x3B2,
                                    false,
                                    "You got near a strange mushroom, but the magic of your orb has helped you avoid it."
                                );
                            }
                            else
                            {
                                textSay =
                                    "You got near a hidden trap, but the magic of your orb has disabled it.";
                                if (Server.Misc.Worlds.IsOnSpaceship(m.Location, m.Map))
                                {
                                    textSay =
                                        "You got near something dangerous, but the magic of your orb has helped you avoid it.";
                                }
                                m.LocalOverheadMessage(
                                    Network.MessageType.Emote,
                                    0x3B2,
                ...
                if (GetPlayerInfo.LuckyPlayer(m.Luck) && nSprung == 1)
                {
                    if (Trap is MushroomTrap)
                    {
                        m.LocalOverheadMessage(
                            ...
                            0x3B2,
                            false,
                            "You got near a strange mushroom, but with luck on your side...you avoid it."
                        );
                    }
                    else
                    {
                        textSay =
                            "You got near a hidden trap, but with luck on your side...it broke.";
                        if (Server.Misc.Worlds.IsOnSpaceship(m.Location, m.Map))
                        {
                            textSay =
                                "You got near something dangerous, but with luck on your side...you avoid it.";
                            m.PlaySound(0x54B);
                        }
                        else
                        {
                ...
                if (m.Backpack != null && nSprung == 1)
                {
                    ...
                    if (tenfootpole != null)
                    {
                        ...
                        if (
                            Server.Items.TenFootPole.TapChance(poles.Weight)
                            ...
                            if (poles.Charges < 1)
                            {
                                if (Trap is MushroomTrap)
                                {
                                    m.LocalOverheadMessage(
                                        ...
                                        0x3B2,
                                        false,
                                        "You break your ten foot pole, but avoid the strange mushroom nearby."
                                    );
                                }
                                else
                                {
                                    textSay =
                                        "You tap your ten foot pole, disabling a hidden trap and breaking the pole.";
                                    if (Server.Misc.Worlds.IsOnSpaceship(m.Location, m.Map))
                                    {
                                        textSay =
                                            "You tap your ten foot pole, avoiding something dangerous and breaking the pole.";
                                    }
                                    m.LocalOverheadMessage(
                                        Network.MessageType.Emote,
                                        0x3B2,
                            ...
                            else
                            {
                                if (Trap is MushroomTrap)
                                {
                                    m.LocalOverheadMessage(
                                        ...
                                        0x3B2,
                                        false,
                                        "You tap your ten foot pole, avoiding a strange mushroom nearby."
                                    );
                                }
                                else
                                {
                                    textSay =
                                        "You tap your ten foot pole, disabling a hidden trap.";
                                    if (Server.Misc.Worlds.IsOnSpaceship(m.Location, m.Map))
                                    {
                                        textSay =
                                            "You tap your ten foot pole, avoiding something dangerous.";
                                    }
                                    m.LocalOverheadMessage(
                                        Network.MessageType.Emote,
                                        0x3B2,
        ...
        public static Item GetMyItem(Mobile m)
        {
            ...
            {
                myBlessCheck = m.FindItemOnLayer(Layer.OuterTorso);
                if (myBlessCheck.LootType == LootType.Blessed)
                {
                    nOuterTorso = 1;
                }
            }
            ...
            {
                myBlessCheck = m.FindItemOnLayer(Layer.OneHanded);
                if (myBlessCheck.LootType == LootType.Blessed)
                {
                    nOneHanded = 1;
                }
            ...
            {
                myBlessCheck = m.FindItemOnLayer(Layer.TwoHanded);
                if (myBlessCheck.LootType == LootType.Blessed)
                {
                    nTwoHanded = 1;
                }
            ...
            if (m.FindItemOnLayer(Layer.Bracelet) != null)
            {
                myBlessCheck = m.FindItemOnLayer(Layer.Bracelet);
                if (myBlessCheck.LootType == LootType.Blessed)
                {
                    nBracelet = 1;
                }
            ...
            if (m.FindItemOnLayer(Layer.Ring) != null)
            {
                myBlessCheck = m.FindItemOnLayer(Layer.Ring);
                if (myBlessCheck.LootType == LootType.Blessed)
                {
                    nRing = 1;
                }
            ...
            if (m.FindItemOnLayer(Layer.Helm) != null)
            {
                myBlessCheck = m.FindItemOnLayer(Layer.Helm);
                if (myBlessCheck.LootType == LootType.Blessed)
                {
                    nHelm = 1;
                }
            ...
            {
                myBlessCheck = m.FindItemOnLayer(Layer.Arms);
                if (myBlessCheck.LootType == LootType.Blessed)
                {
                    nArms = 1;
                }
            ...
            {
                myBlessCheck = m.FindItemOnLayer(Layer.OuterLegs);
                if (myBlessCheck.LootType == LootType.Blessed)
                {
                    nOuterLegs = 1;
                }
            ...
            if (m.FindItemOnLayer(Layer.Neck) != null)
            {
                myBlessCheck = m.FindItemOnLayer(Layer.Neck);
                if (myBlessCheck.LootType == LootType.Blessed)
                {
                    nNeck = 1;
                }
            ...
            {
                myBlessCheck = m.FindItemOnLayer(Layer.Gloves);
                if (myBlessCheck.LootType == LootType.Blessed)
                {
                    nGloves = 1;
                }
            ...
            {
                if (!(m.FindItemOnLayer(Layer.Talisman) is Spellbook))
                {
                    myBlessCheck = m.FindItemOnLayer(Layer.Talisman);
                    if (myBlessCheck.LootType == LootType.Blessed)
                    {
                        nTalisman = 1;
                    }
            ...
            {
                myBlessCheck = m.FindItemOnLayer(Layer.Shoes);
                if (myBlessCheck.LootType == LootType.Blessed)
                {
                    nShoes = 1;
                }
            }
            if (m.FindItemOnLayer(Layer.Cloak) != null)
            {
                myBlessCheck = m.FindItemOnLayer(Layer.Cloak);
                if (myBlessCheck.LootType == LootType.Blessed)
                {
                    nCloak = 1;
                }
            ...
            {
                myBlessCheck = m.FindItemOnLayer(Layer.FirstValid);
                if (myBlessCheck.LootType == LootType.Blessed)
                {
                    nFirstValid = 1;
                }
            ...
            {
                myBlessCheck = m.FindItemOnLayer(Layer.Waist);
                if (myBlessCheck.LootType == LootType.Blessed)
                {
                    nWaist = 1;
                }
            ...
            {
                myBlessCheck = m.FindItemOnLayer(Layer.InnerLegs);
                if (myBlessCheck.LootType == LootType.Blessed)
                {
                    nInnerLegs = 1;
                }
            ...
            {
                myBlessCheck = m.FindItemOnLayer(Layer.InnerTorso);
                if (myBlessCheck.LootType == LootType.Blessed)
                {
                    nInnerTorso = 1;
                }
            ...
            {
                myBlessCheck = m.FindItemOnLayer(Layer.Pants);
                if (myBlessCheck.LootType == LootType.Blessed)
                {
                    nPants = 1;
                }
            ...
            {
                myBlessCheck = m.FindItemOnLayer(Layer.Shirt);
                if (myBlessCheck.LootType == LootType.Blessed)
                {
                    nShirt = 1;
                }
            ...
            if (m.FindItemOnLayer(Layer.Earrings) != null)
            {
                myBlessCheck = m.FindItemOnLayer(Layer.Earrings);
                if (myBlessCheck.LootType == LootType.Blessed)
                {
                    nEarrings = 1;
                }
            ...
            if (nOrder == 1)
            {
                if (m.FindItemOnLayer(Layer.Waist) != null && nWaist != 1)
                {
                    myItem = m.FindItemOnLayer(Layer.Waist);
                }
                else if (m.FindItemOnLayer(Layer.OuterTorso) != null && nOuterTorso != 1)
                {
                    myItem = m.FindItemOnLayer(Layer.OuterTorso);
                }
                else if (m.FindItemOnLayer(Layer.OneHanded) != null && nOneHanded != 1)
                {
                    myItem = m.FindItemOnLayer(Layer.OneHanded);
                }
                else if (m.FindItemOnLayer(Layer.TwoHanded) != null && nTwoHanded != 1)
                {
                    myItem = m.FindItemOnLayer(Layer.TwoHanded);
                }
                else if (m.FindItemOnLayer(Layer.Bracelet) != null && nBracelet != 1)
                {
                    myItem = m.FindItemOnLayer(Layer.Bracelet);
                }
                else if (m.FindItemOnLayer(Layer.Ring) != null && nRing != 1)
                {
                    myItem = m.FindItemOnLayer(Layer.Ring);
                }
                else if (m.FindItemOnLayer(Layer.Helm) != null && nHelm != 1)
                {
                    myItem = m.FindItemOnLayer(Layer.Helm);
                }
                else if (m.FindItemOnLayer(Layer.Arms) != null && nArms != 1)
                {
                    myItem = m.FindItemOnLayer(Layer.Arms);
                }
                else if (m.FindItemOnLayer(Layer.OuterLegs) != null && nOuterLegs != 1)
                {
                    myItem = m.FindItemOnLayer(Layer.OuterLegs);
                }
                else if (m.FindItemOnLayer(Layer.Neck) != null && nNeck != 1)
                {
                    myItem = m.FindItemOnLayer(Layer.Neck);
                }
                else if (m.FindItemOnLayer(Layer.Gloves) != null && nGloves != 1)
                {
                    myItem = m.FindItemOnLayer(Layer.Gloves);
                }
                else if (m.FindItemOnLayer(Layer.Talisman) != null && nTalisman != 1)
                {
                    myItem = m.FindItemOnLayer(Layer.Talisman);
                }
                else if (m.FindItemOnLayer(Layer.Shoes) != null && nShoes != 1)
                {
                    myItem = m.FindItemOnLayer(Layer.Shoes);
                }
                else if (m.FindItemOnLayer(Layer.Cloak) != null && nCloak != 1)
                {
                    myItem = m.FindItemOnLayer(Layer.Cloak);
                }
                else if (m.FindItemOnLayer(Layer.FirstValid) != null && nFirstValid != 1)
                {
                    myItem = m.FindItemOnLayer(Layer.FirstValid);
                }
                else if (m.FindItemOnLayer(Layer.InnerLegs) != null && nInnerLegs != 1)
                {
                    myItem = m.FindItemOnLayer(Layer.InnerLegs);
                }
                else if (m.FindItemOnLayer(Layer.InnerTorso) != null && nInnerTorso != 1)
                {
                    myItem = m.FindItemOnLayer(Layer.InnerTorso);
                }
                else if (m.FindItemOnLayer(Layer.Pants) != null && nPants != 1)
                {
                    myItem = m.FindItemOnLayer(Layer.Pants);
                }
                else if (m.FindItemOnLayer(Layer.Shirt) != null && nShirt != 1)
                {
                    myItem = m.FindItemOnLayer(Layer.Shirt);
                }
                else if (m.FindItemOnLayer(Layer.Earrings) != null && nEarrings != 1)
                {
                    myItem = m.FindItemOnLayer(Layer.Earrings);
                }
            }
            else if (nOrder == 2)
            {
                if (m.FindItemOnLayer(Layer.OuterTorso) != null && nOuterTorso != 1)
                {
                    myItem = m.FindItemOnLayer(Layer.OuterTorso);
                }
                else if (m.FindItemOnLayer(Layer.OneHanded) != null && nOneHanded != 1)
                ...
                else if (m.FindItemOnLayer(Layer.Waist) != null && nWaist != 1)
                {
                    myItem = m.FindItemOnLayer(Layer.Waist);
                }
            }
            ...
            {
                if (m.FindItemOnLayer(Layer.OneHanded) != null && nOneHanded != 1)
                {
                    myItem = m.FindItemOnLayer(Layer.OneHanded);
                }
                else if (m.FindItemOnLayer(Layer.TwoHanded) != null && nTwoHanded != 1)
            ...
            {
                if (m.FindItemOnLayer(Layer.TwoHanded) != null && nTwoHanded != 1)
                {
                    myItem = m.FindItemOnLayer(Layer.TwoHanded);
                }
                else if (m.FindItemOnLayer(Layer.Bracelet) != null && nBracelet != 1)
            ...
            {
                if (m.FindItemOnLayer(Layer.Bracelet) != null && nBracelet != 1)
                {
                    myItem = m.FindItemOnLayer(Layer.Bracelet);
                }
                else if (m.FindItemOnLayer(Layer.Ring) != null && nRing != 1)
            ...
            {
                if (m.FindItemOnLayer(Layer.Ring) != null && nRing != 1)
                {
                    myItem = m.FindItemOnLayer(Layer.Ring);
                }
                else if (m.FindItemOnLayer(Layer.Helm) != null && nHelm != 1)
            ...
            {
                if (m.FindItemOnLayer(Layer.Helm) != null && nHelm != 1)
                {
                    myItem = m.FindItemOnLayer(Layer.Helm);
                }
                else if (m.FindItemOnLayer(Layer.Arms) != null && nArms != 1)
            ...
            {
                if (m.FindItemOnLayer(Layer.Arms) != null && nArms != 1)
                {
                    myItem = m.FindItemOnLayer(Layer.Arms);
                }
                else if (m.FindItemOnLayer(Layer.OuterLegs) != null && nOuterLegs != 1)
            ...
            {
                if (m.FindItemOnLayer(Layer.OuterLegs) != null && nOuterLegs != 1)
                {
                    myItem = m.FindItemOnLayer(Layer.OuterLegs);
                }
                else if (m.FindItemOnLayer(Layer.Neck) != null && nNeck != 1)
            ...
            {
                if (m.FindItemOnLayer(Layer.Neck) != null && nNeck != 1)
                {
                    myItem = m.FindItemOnLayer(Layer.Neck);
                }
                else if (m.FindItemOnLayer(Layer.Gloves) != null && nGloves != 1)
            ...
            {
                if (m.FindItemOnLayer(Layer.Gloves) != null && nGloves != 1)
                {
                    myItem = m.FindItemOnLayer(Layer.Gloves);
                }
                else if (m.FindItemOnLayer(Layer.Talisman) != null && nTalisman != 1)
            ...
            {
                if (m.FindItemOnLayer(Layer.Talisman) != null && nTalisman != 1)
                {
                    myItem = m.FindItemOnLayer(Layer.Talisman);
                }
                else if (m.FindItemOnLayer(Layer.Shoes) != null && nShoes != 1)
            ...
            {
                if (m.FindItemOnLayer(Layer.Shoes) != null && nShoes != 1)
                {
                    myItem = m.FindItemOnLayer(Layer.Shoes);
                }
                else if (m.FindItemOnLayer(Layer.Cloak) != null && nCloak != 1)
            ...
            {
                if (m.FindItemOnLayer(Layer.Cloak) != null && nCloak != 1)
                {
                    myItem = m.FindItemOnLayer(Layer.Cloak);
                }
                else if (m.FindItemOnLayer(Layer.FirstValid) != null && nFirstValid != 1)
            ...
            {
                if (m.FindItemOnLayer(Layer.FirstValid) != null && nFirstValid != 1)
                {
                    myItem = m.FindItemOnLayer(Layer.FirstValid);
                }
                else if (m.FindItemOnLayer(Layer.InnerLegs) != null && nInnerLegs != 1)
            ...
            {
                if (m.FindItemOnLayer(Layer.InnerLegs) != null && nInnerLegs != 1)
                {
                    myItem = m.FindItemOnLayer(Layer.InnerLegs);
                }
                else if (m.FindItemOnLayer(Layer.InnerTorso) != null && nInnerTorso != 1)
            ...
            {
                if (m.FindItemOnLayer(Layer.InnerTorso) != null && nInnerTorso != 1)
                {
                    myItem = m.FindItemOnLayer(Layer.InnerTorso);
                }
                else if (m.FindItemOnLayer(Layer.Pants) != null && nPants != 1)
            ...
            {
                if (m.FindItemOnLayer(Layer.Pants) != null && nPants != 1)
                {
                    myItem = m.FindItemOnLayer(Layer.Pants);
                }
                else if (m.FindItemOnLayer(Layer.Shirt) != null && nShirt != 1)
            ...
            {
                if (m.FindItemOnLayer(Layer.Shirt) != null && nShirt != 1)
                {
                    myItem = m.FindItemOnLayer(Layer.Shirt);
                }
                else if (m.FindItemOnLayer(Layer.Earrings) != null && nEarrings != 1)
            ...
            {
                if (m.FindItemOnLayer(Layer.Earrings) != null && nEarrings != 1)
                {
                    myItem = m.FindItemOnLayer(Layer.Earrings);
                }
                else if (m.FindItemOnLayer(Layer.Waist) != null && nWaist != 1)
        ...
        {
            get { return MyServerSettings.EnableDungeonSoundEffects(); }
        }

        private DateTime m_NextSound;
        public DateTime NextSound
        {
            get { return m_NextSound; }
            set { m_NextSound = value; }
        }
