...
namespace Server.Regions
{
    ...
    public class BaseRegion : Region
    {
                ...
                if (Server.Misc.Worlds.PlayersLeftInRegion(m, this) == false)
                {
                    if (this is DungeonRegion || this is BardDungeonRegion)
                    {
                        ...
                        foreach (Mobile creature in World.Mobiles.Values)
                            if (
                                Server.Misc.Worlds.GetRegionName(creature.Map, creature.Location)
                                    == this.Name
                            ...
                            )
                            {
                                ...
                                if (
                                    loc.X > 0
                                    && dweller.RangeHome < 10
                                    && dweller.SummonMaster == null
                                    && dweller.ControlMaster == null
                                )
                                {
                    ...
                    for (int k = m_RectBuffer2.Count - 1; k >= 0; k--)
                    {
                        ...
                        if (l1 < r2 && r1 > l2 && t1 < b2 && b1 > t2)
                        {
                            ...
                            if (l1 < l2)
                            {
                                m_RectBuffer2.Add(
                                    new Rectangle3D(
                                        new Point3D(l1, t1, sz),
                                        new Point3D(l2, b1, ez)
                                    )
                                );
                            }
                            ...
                            if (r1 > r2)
                            {
                                m_RectBuffer2.Add(
                                    new Rectangle3D(
                                        new Point3D(r2, t1, sz),
                                        new Point3D(r1, b1, ez)
                                    )
                                );
                            }
        ...
        public Point3D RandomSpawnLocation(
            int spawnHeight,
            bool land,
            bool water,
            Point3D home,
